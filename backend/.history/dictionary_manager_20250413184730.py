...
def process_tagalog_words(cur, filename: str):
    ...
    stats = {
        ...
        "capitalized_words_matched": 0,  # Track capitalized words matched to existing words
        "capitalized_words_new": 0,  # Track capitalized words stored as new entries
    }
                                                    ...
                                                    if (
                                                        ...
                                                        try:
                                                            ...
                                                            if is_fully_capitalized:
                                                                ...
                                                                """, (item_word_clean, item_word_clean))
                                                                result = cur.fetchone()
                                                                if result:
    ...
    # This block will execute if the main try block completes without fatal errors
        ...
        logger.info(f"  Capitalized words stored as new entries: {stats['capitalized_words_new']}")
