                ...
                if field in entry and isinstance(entry[field], list):
                    for related_item in entry[field]:
                        ...
                        if related_word_str:
                            ...
                            # Check if this is a non-word string like a language code or descriptor
                            if related_word_clean.lower() in NON_WORD_STRINGS:
                                logger.debug(f"Storing language code or descriptor '{related_word_clean}' as metadata for word '{word}'")
                                ...
                                # Initialize linguistic_notes array in word_metadata if needed
                                if "linguistic_notes" not in word_metadata:
                                ...
                                note_entry = {
                                    ...
                                    "source_field": field  # Track which field this came from
                                }
                                
                                # Add to linguistic_notes if not already present
                                if note_entry not in word_metadata["linguistic_notes"]:
                                    word_metadata["linguistic_notes"].append(note_entry)
                                    logger.info(f"Added {metadata_category} '{related_word_clean}' to metadata for word '{word}'")
