...
from schemas import WordSchema # Check if this covers needed schemas
...
def get_word(word: str):
    """Get detailed information about a specific word, including all relations."""
    logger.debug(f"Fetching word details: {word}")
        ...
        if include_definitions:
            try:
                ...
                if definition_ids:
                    ...
                    try:
                        # Modified SQL to select all columns from definition_categories table
                        sql_categories = """
                        SELECT id, definition_id, category_name, category_kind, 
                               category_metadata, parents, created_at, updated_at
