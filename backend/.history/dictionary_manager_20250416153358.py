                    ...
                    for related_item in entry[field]:
                        ...
                        if related_word_str:
                            ...
                            if related_word_clean and related_word_clean.lower() != word.lower():
                                ...
                                if len(related_word_clean) <= 3 or " " in related_word_clean or "-based" in related_word_clean.lower():
                                    logger.info(f"Skipping likely non-word entry '{related_word_clean}' for word '{word}'")
                                    continue
