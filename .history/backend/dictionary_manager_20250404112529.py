...
POS_MAPPING = {
    ...
    "pangalanang pantangi": "n",  # Proper noun
    "pangalanang pambalana": "n",  # Common noun
    ...
    "punto": "punc",               # Punctuation
    "antas na paghahambing": "adj", # Comparative
    "katumbas na salita": "n",      # Equivalent term  
    "kahulugan": "n",               # Definition
    "kabaliktaran": "n",            # Antonym
    "aspekto": "n",                 # Aspect
    "kasarian": "n",                # Gender
    "karamihan": "num",             # Number (grammatical)
    "anyo": "n",                    # Form
    "kayarian": "n",                # Structure
    "gamit": "n",                   # Usage
    "pagkakaugnay": "n",            # Relation
    # Add KWF-specific terms
    "salitang ugat": "n",           # Root word
    "salitang hango": "n",          # Derived word
    "pulutong": "n",                # Group/category  
    "sangkap": "n",                 # Component
    "uri": "n",                     # Type
    "simbolo": "n",                 # Symbol
    "dinidiinang pantig": "n",      # Stressed syllable
    "pagbabago": "n",               # Variation
    "palatandaan": "n",             # Marker
    "pahiwatig": "n",               # Indication
    "tugma": "n",                   # Rhyme
    "kahulugan": "n",               # Gloss
    "salitang hiram": "n",          # Loan word
    "damdamin": "n",                # Emotion
    # Direct KWF dictionary mappings
    "Pangngalan": "n",
    "Pandiwa": "v",
    "Pang-uri": "adj",
    "Pang-abay": "adv",
    ...
    if isinstance(pos_str, list) and pos_str:
        ...
        for pos_item in pos_str:
            if pos_item and isinstance(pos_item, str) and pos_item.strip():
                return get_standard_code(pos_item)
        return "unc"
