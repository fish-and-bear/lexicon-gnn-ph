...
def process_tagalog_words(cur, filename: str, progress: Progress = None, task_id: TaskID = None):
    """
    ...
    Args:
        ...
        progress: Optional Progress instance for displaying progress
        task_id: Optional TaskID for updating the progress display
