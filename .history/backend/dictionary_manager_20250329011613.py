...
def process_relationships(cur, word_id, data, sources):
    ...
    try:
        ...
        # Removed automatic Filipino word variations generation - this approach was linguistically 
        # inaccurate and could produce invalid words. Spelling variations should be handled 
        # through explicit dictionary entries instead.
