    ...
    try:
        ...
        with conn.cursor(cursor_factory=psycopg2.extras.DictCursor) as cur:
            ...
            for result in results:
                ...
                norm_lemma = result["normalized_lemma"]
                pref_spell = result["preferred_spelling"]
                has_bayb = result["has_baybayin"]
                bayb_form = result["baybayin_form"]
                rom_form = result["romanized_form"]
                tags = result["tags"]
                ...
                if etyms:
                    console.print("\n[bold cyan]Etymology:[/]")
                    for etym in etyms:
                        etym_text = etym["etymology_text"]
                        comps = etym["normalized_components"]
                        langs = etym["language_codes"]
                        e_sources = etym["sources"]
                ...
                if definitions:
                    ...
                    for definition in definitions:
                        ...
                        notes = definition["usage_notes"]
                        def_tags = definition["tags"]
                        def_sources = definition["sources"]
                        pos = definition["pos_name"]
