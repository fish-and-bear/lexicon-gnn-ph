            ...
            return
                ...
                for result in results:
                    (word_id, lemma, lang_code, norm_lemma, pref_spell, 
                     has_bayb, bayb_form, rom_form, tags, sources,
                     badlit_form) = result[:11]  # Exclude similarity score if present
