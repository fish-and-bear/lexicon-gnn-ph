...
supports_baybayin = language_system.supports_baybayin
get_all_languages = language_system.get_all_languages
convert_script = language_validator.convert_script
get_script_features = language_validator.get_script_features 