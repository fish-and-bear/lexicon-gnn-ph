...
class Word(db.Model):
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        result = {
            ...
            "word_metadata": json.loads(self.word_metadata) if isinstance(self.word_metadata, str) else self.word_metadata,
        ...
        if is_testing_db(db.engine):
            ...
            try:
                ...
                try:
                    ...
                    db.session.rollback()
                    print(f"Warning: Failed to create collation: {e}")
            ...
            # Create cleanup trigger for PostgreSQL
            try:
                db.session.execute(text("""
...
$$ LANGUAGE plpgsql;
                    ...
                    DROP TRIGGER IF EXISTS cleanup_word_data_trigger ON words;
...
EXECUTE FUNCTION cleanup_word_data();
                ...
                db.session.rollback()
                print(f"Warning: Failed to create cleanup trigger: {e}")
