...
def create_timestamp_function(target, connection, **kw):
    ...
    try:
        connection.execute(get_index_ddl(connection))
        print(f"Created indexes successfully")
        ...
        try:
            ...
            print("Indexes may not be created correctly")
...
def create_timestamp_trigger(target, connection, **kw):
    ...
    try:
        ...
        try:
            ...
            print(f"Indexes for {target.name} will not update automatically")
