    ...
    def _ensure_bidirectional_exists(self, from_word_id: int, to_word_id: int, 
        ...
        try:
            ...
            if existing:
                ...
                # Check sources
                if sources:
                    normalized_sources = ", ".join(sorted(set(sources.split(", "))))
                ...
                if update_needed:
                    ...
                    normalized_sources = ", ".join(sorted(set(sources.split(", ")))) if sources else ""
                    combined_sources = ", ".join(sorted(set(
                        (existing_sources.split(", ") if existing_sources else []) + 
                        (normalized_sources.split(", ") if normalized_sources else [])
                ...
                """, (from_word_id, to_word_id, rel_type_str, sources or "", json.dumps(metadata or {})))
