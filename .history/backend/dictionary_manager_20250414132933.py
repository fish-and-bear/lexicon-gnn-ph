...
def _process_single_tagalog_word_entry(cur, entry_data: dict, word_key: str, source_identifier: str, language_code: str, add_etymology: bool, word_id_cache: dict, stats: dict, error_types: dict, table_column_map: dict, relations_batch: list) -> bool:
    """
