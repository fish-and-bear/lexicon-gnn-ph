    ...
    try:
        ...
        if hasattr(engine_or_conn, 'connect'):
            ...
            with engine_or_conn.connect() as conn:
                # Execute the DDL statements for constraints
                conn.execute(text("""
                ...
                # Execute the DDL for TSVECTOR search text
                conn.execute(text("""
                    DO $$ 
                    BEGIN
                        IF NOT EXISTS (
    ...
    try:
        with app.app_context():
            ...
            try:
                ...
                print("Application will continue, but some database features may not work correctly.")
    except Exception as e:
