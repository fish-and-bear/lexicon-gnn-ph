...
def insert_etymology(
    ...
    language_codes: str = None,  # Instead of source_languages
    sources: str = ""
) -> None:
    """
    ...
    Args:
        ...
        language_codes: Comma-separated list of language codes (replacing source_languages)
    ...
    try:
        ...
        logger.error(f"Error in insert_etymology: {str(e)}")
        raise
...
def extract_language_codes(etymology: str) -> list:
    """
    Extract language codes from an etymology string.
    Example: "from Latin" -> ["la"]
    ...
    etymology = etymology.lower()
    found_languages = []
    
    for language, code in language_mapping.items():
        if language in etymology:
            found_languages.append(code)
