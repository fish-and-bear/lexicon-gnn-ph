...
class Definition(db.Model):
    ...
    word = db.relationship('Word', backref='definitions')
...
class Relation(db.Model):
    ...
    source_word = db.relationship('Word', foreign_keys=[source_word_id], backref='outgoing_relations')
    target_word = db.relationship('Word', foreign_keys=[target_word_id], backref='incoming_relations')
...
class PartOfSpeech(db.Model):
    ...
    # Relationships
    definitions = db.relationship('Definition', backref='part_of_speech', lazy='dynamic')
