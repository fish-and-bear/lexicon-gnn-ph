    ...
    try:
        ...
        if result.returncode != 0:
            ...
            dict_migration = subprocess.run(
                [sys.executable, "dictionary_manager.py", "migrate", "--data-dir", data_dir, "--handle-numeric-suffixes"],
                capture_output=True,
                text=True
            )
            ...
            verify = subprocess.run(
                [sys.executable, "dictionary_manager.py", "verify", "--check-numeric-suffixes"],
                capture_output=True,
                text=True
            )
