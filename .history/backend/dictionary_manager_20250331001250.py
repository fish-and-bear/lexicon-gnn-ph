...
def process_kwf_dictionary(cur, filename: str):
    ...
    try:
        ...
        pbar = tqdm(total=len(entries), desc="Processing KWF entries", unit="entries")
        ...
        relation_mapping = {
            ...
            "related form": "related_form",
            "related entry": "related_entry",
            "related concept": "related_concept",
            "related phrase": "related_phrase",
            "related expression": "related_expression",
            "related idiom": "related_idiom",
            "related proverb": "related_proverb",
            "related saying": "related_saying",
            "related quote": "related_quote",
            "related citation": "related_citation",
            "related reference": "related_reference",
            "related source": "related_source",
            "related work": "related_work",
            "related literature": "related_literature",
            "related author": "related_author",
            "related book": "related_book",
            "related article": "related_article",
            "related chapter": "related_chapter",
            "related section": "related_section",
            "related passage": "related_passage",
            "related verse": "related_verse",
            "related line": "related_line",
            "related stanza": "related_stanza",
            "related poem": "related_poem",
            "related song": "related_song",
            "related music": "related_music",
            "related film": "related_film",
            "related movie": "related_movie",
            "related television": "related_television",
            "related show": "related_show",
            "related episode": "related_episode",
            "related scene": "related_scene",
            "related character": "related_character",
            "related actor": "related_actor",
            "related actress": "related_actress",
            "related director": "related_director",
            "related producer": "related_producer",
            "related screenwriter": "related_screenwriter",
            "related composer": "related_composer",
            "related lyricist": "related_lyricist",
            "related artist": "related_artist",
            "related band": "related_band",
            "related group": "related_group",
            "related instrument": "related_instrument",
            "related genre": "related_genre",
            "related style": "related_style",
            "related movement": "related_movement",
            "related era": "related_era",
            "related period": "related_period",
            "related event": "related_event",
            "related history": "related_history",
            "related culture": "related_culture",
            "related tradition": "related_tradition",
            "related custom": "related_custom",
            "related ritual": "related_ritual",
            "related festival": "related_festival",
            "related holiday": "related_holiday",
            "related ceremony": "related_ceremony",
            "related rite": "related_rite",
            "related practice": "related_practice",
            "related habit": "related_habit",
            "related custom": "related_custom",
            "related usage": "related_usage",
            "related example": "related_example",
            "related illustration": "related_illustration",
            "related image": "related_image",
            "related diagram": "related_diagram",
            "related chart": "related_chart",
            "related graph": "related_graph",
            "related map": "related_map",
            "related atlas": "related_atlas",
            "related globe": "related_globe",
            "related model": "related_model",
            "related simulation": "related_simulation",
            "related experiment": "related_experiment",
            "related test": "related_test",
            "related trial": "related_trial",
            "related study": "related_study",
            "related research": "related_research",
            "related investigation": "related_investigation",
            "related analysis": "related_analysis",
            "related experimentation": "related_experimentation",
            "related trial and error": "related_trial_and_error",
            "related hypothesis": "related_hypothesis",
            "related theory": "related_theory",
            "related principle": "related_principle",
            "related law": "related_law",
            "related rule": "related_rule",
            "related regulation": "related_regulation",
            "related policy": "related_policy",
            "related guideline": "related_guideline",
            "related standard": "related_standard",
            "related norm": "related_norm",
            "related convention": "related_convention",
            "related custom": "related_custom",
            "related practice": "related_practice",
            "related procedure": "related_procedure",
            "related protocol": "related_protocol",
            "related method": "related_method",
            "related technique": "related_technique",
            "related technique": "related_technique",
            "related technique": "related_technique",
            "related technique": "related_technique",
            "related technique": "related_technique",
...
def process_kaikki_jsonl(cur, filename: str):
    ...
    # Initialize progress bar with dynamic description
    pbar = tqdm(total=total_lines, desc="Processing Kaikki entries", unit="entries")
...
// ... existing code ...
                ...
                try:
                    ...
                    if result:
                        ...
                        try:
                            ...
                            if current_time - last_commit_time >= 1.0:  # Update at most once per second
                                # Calculate processing rate
                                elapsed_time = current_time - pbar.start_t
                                rate = processed / elapsed_time if elapsed_time > 0 else 0
                                
                                # Update progress bar description with detailed stats
                                desc = f"[{rate:.1f} entries/s] Processed: {processed}, Skipped: {skipped}, Errors: {errors}"
                    ...
                    logger.error(f"Error decoding JSON at line {entry_count}: {str(json_error)}")
                    stats["error_entries"] += 1
                    errors += 1
                    pbar.update(1)
                    continue
    ...
    logger.info(f"Processing complete. Total entries: {stats['total_entries']}")
