...
try:
    ...
    from .database import get_pool_status, db, teardown_db
except ImportError:
...
def update_system_metrics():
    ...
    try:
        ...
        DB_POOL_USED.set(pool_status['checkedout'])
...
def create_app(testing=False):
    ...
    from backend.database import db, teardown_db
    ...
    def health_check():
        ...
        health_data = {
            ...
            "database": {
                "status": db_status,
                "pool": get_pool_status() if db_status == "ok" else None
            },
            "system": {
    ...
    if not testing:
        search_tasks_thread = search_tasks.initialize()
