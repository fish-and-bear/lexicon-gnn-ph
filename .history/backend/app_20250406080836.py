...
def create_app(testing=False):
    ...
    cors_resources = {
        r"/api/*": {
            # Explicitly allow the React development server origin
    ...
    db.init_app(app)
    # Explicitly set the migrations directory using an absolute path
    basedir = os.path.abspath(os.path.dirname(__file__))
    migrations_dir = os.path.join(basedir, 'alembic', 'migrations')
