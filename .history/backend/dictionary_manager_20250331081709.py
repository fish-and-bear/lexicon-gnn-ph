            ...
            try:
                ...
                for entry in entries:
                    try:
                        ...
                        # Process pronunciation with validation
                        ...
                        # Process credits with standardization
                        ...
                        if not isinstance(definitions, list):
                            logger.warning(f"Invalid definitions format for '{base_word}' in {filename}")
                            definitions = []
                        ...
                        for def_item in definitions:
                            try:
                                ...
                                examples_json = json.dumps(valid_examples) if valid_examples else None
                        ...
                        if isinstance(see_also, list) and see_also:
                            ...
                            for ref in see_also:
                                if isinstance(ref, dict):
                                    ...
                                    # Remove numbers from references and avoid self-references
                                    ref_base = re.sub(r'\d+$', '', text)
                                    if text and ref_base != base_word:
                        ...
                        logger.error(f"Error processing entry for '{base_word}' in {filename}: {str(e)}")
                        stats["errors"] += 1
                        continue
