...
def transliterate_baybayin():
    ...
    try:
        ...
        to_baybayin = request.args.get("to_baybayin", "true").lower() == "true"
        
        if not text:
            return error_response("Text parameter is required", 400, error_code="ERR_VALIDATION")
        ...
        return error_response("Failed to transliterate text")
