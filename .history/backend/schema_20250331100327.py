...
class RelationshipTypeEnum(graphene.Enum):
    ...
    def description(self):
        return {
            ...
            'HYPERNYM': 'A word with a broader meaning than a more specific word',
            'HYPONYM': 'A word with a more specific meaning than a more general word',
            'MERONYM': 'A word that denotes a part of something',
            'HOLONYM': 'A word that denotes a whole of which the meronym is a part',
            'DERIVED': 'A word derived from another word',
            'ROOT': 'The root word from which another word is derived',
            'VARIANT': 'Alternative forms or spellings of a word',
            'COGNATE': 'Words that share a common etymological origin',
            'BORROWED': 'Words borrowed from another language',
            'CULTURAL': 'Words with cultural relationships',
            'SUBJECT_OF': 'Word that is the subject of an action',
            'OBJECT_OF': 'Word that is the object of an action',
            'COLLOCATE': 'Words that commonly occur together'
        }.get(self.name, '')
...
class RelationshipCategoryEnum(graphene.Enum):
    ...
    def description(self):
        return {
            ...
            'MORPHOLOGICAL': 'Relationships based on word structure',
            'SYNTACTIC': 'Relationships based on grammatical function',
            'ETYMOLOGICAL': 'Relationships based on word origin',
            'CULTURAL': 'Relationships based on cultural context'
        }.get(self.name, '')
...
class VerificationStatusEnum(graphene.Enum):
    ...
    def description(self):
        return {
            'UNVERIFIED': 'Data has not been verified',
            'VERIFIED': 'Data has been verified by an expert',
            'NEEDS_REVIEW': 'Data needs review by an expert',
            'DISPUTED': 'Data accuracy is disputed'
        }.get(self.name, '')
