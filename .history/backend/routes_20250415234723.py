                ...
                if definition_ids:
                    ...
                    try:
                        ...
                        for c_row in cat_results:
                            ...
                            # Assign fields safely, one at a time
                            cat.id = c_row.id
                            cat.definition_id = c_row.definition_id
                            cat.category_name = c_row.category_name
                            if hasattr(c_row, 'category_kind'):
                                cat.category_kind = c_row.category_kind
                            if hasattr(c_row, 'parents'):
                                cat.parents = c_row.parents
                            # Set metadata as empty dict since column doesn't exist
                            cat.category_metadata = {}
                            # Initialize tags explicitly as None or an empty dict
                            cat.tags = {}
                        ...
                        # Don't abort transaction, just continue with empty categories
