    ...
    try:
        ...
        word_result = db.session.execute(text("""
            SELECT id, lemma, normalized_lemma, language_code, 
                   ...
                   COALESCE(idioms, '{}') as idioms, 
                   COALESCE(source_info, '{}') as source_info, 
                   data_hash, search_text,
                   badlit_form, 
                   COALESCE(hyphenation, '{}') as hyphenation, 
                   COALESCE(is_proper_noun, FALSE) as is_proper_noun, 
                   COALESCE(is_abbreviation, FALSE) as is_abbreviation, 
                   COALESCE(is_initialism, FALSE) as is_initialism, 
        ...
        optional_fields = [
            "idioms", "source_info", "data_hash", "search_text", "badlit_form", "hyphenation",
