        ...
        if include_definitions:
            try:
                ...
                if definition_ids:
                    ...
                    try:
                        sql_cats = """
                        SELECT id, definition_id, category_name, /* REMOVED description, */ category_kind, tags, category_metadata, parents
                        ...
                        for c_row in cat_results:
                            ...
                            # Assign fields, omitting description
                            cat.id = c_row.id; cat.definition_id = c_row.definition_id; cat.category_name = c_row.category_name; cat.category_kind = c_row.category_kind; cat.tags = c_row.tags; cat.category_metadata = c_row.category_metadata; cat.parents = c_row.parents
