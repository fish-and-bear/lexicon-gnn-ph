...
class Affixation(db.Model):
    ...
    root_word = db.relationship('Word', foreign_keys=[root_word_id], backref='affixations_as_root')
    affixed_word = db.relationship('Word', foreign_keys=[affixed_word_id], backref='affixations_as_affixed')
