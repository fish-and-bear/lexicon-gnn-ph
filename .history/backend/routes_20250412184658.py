        ...
        if include_root and word.root_word_id:
            try:
                ...
                if root_result:
                    ...
                    # Safe handling for root word baybayin form
                    try:
                        baybayin_form = root_result.baybayin_form
                        if baybayin_form and len(baybayin_form.strip()) > 0:
                            root_word.baybayin_form = baybayin_form
                        else:
                            root_word.baybayin_form = None
                            root_word.has_baybayin = False
                    except ValueError:
                        # Invalid baybayin form, set to None
                        root_word.baybayin_form = None
                        root_word.has_baybayin = False
