...
# Enums
RelationshipTypeEnum = graphene.Enum.from_enum(RelationshipType)
RelationshipCategoryEnum = graphene.Enum.from_enum(RelationshipCategory)
...
VerificationStatusEnum = graphene.Enum('VerificationStatus', [
