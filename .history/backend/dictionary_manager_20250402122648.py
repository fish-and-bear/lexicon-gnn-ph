...
def process_entry(cur, entry: Dict, filename=None, check_exists=False) -> Optional[int]:
    ...
    Args:
        ...
        filename: Source filename (optional) used to derive source_identifier
    ...
    # Standardize source identifier from filename
    source_identifier = standardize_source_identifier(filename)
