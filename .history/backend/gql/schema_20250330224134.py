...
class WordType(SQLAlchemyObjectType):
    class Meta:
        ...
        only_fields = ('id', 'lemma', 'normalized_lemma', 'has_baybayin', 
                      'baybayin_form', 'romanized_form', 'language_code',
                      'root_word_id', 'preferred_spelling', 'tags', 'idioms',
                      'pronunciation_data', 'source_info', 'metadata', 'data_hash',
                      'created_at', 'updated_at', 'search_text', 'badlit_form',
                      'hyphenation', 'is_proper_noun', 'is_abbreviation',
                      'is_initialism')
