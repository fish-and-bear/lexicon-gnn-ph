...
def create_app(testing=False):
    ...
    cors_resources = {
        r"/api/*": {
            # Allow all origins that might be used
            "origins": ["http://localhost:3000", "http://127.0.0.1:3000", "http://0.0.0.0:3000", "https://fil-relex.onrender.com"],
            "methods": ["GET", "POST", "OPTIONS", "PUT", "DELETE"],
            "allow_headers": ["Content-Type", "Authorization", "X-Requested-With", "Accept", "Origin", "Access-Control-Request-Method", "Access-Control-Request-Headers"],
            "expose_headers": ["Content-Type", "X-Total-Count", "X-Pagination-Pages", "X-Request-ID"],
