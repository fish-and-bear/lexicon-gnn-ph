...
from backend.security import validate_json_request
...
@multi_level_cache
@validate_json_request(WordQuerySchema)
...
@multi_level_cache
@validate_json_request(SearchQuerySchema)
...
@validate_json_request(WordRelationshipSchema)
...
@multi_level_cache(ttl=3600)
@validate_json_request(EtymologyTreeSchema)
