        ...
        for base_word, variants in data.items():
            ...
            for variant, details in variants.items():
                ...
                if variant == base_word:
                    ...
                    variant_definition = f"[Variant: {variant}] {definition_text}"
                    insert_definition(
                        cur,
                        variant_id,
                        variant_definition,
                    ...
                    insert_relation(cur, variant_id, base_word_id, "derived", sources=SourceStandardization.standardize_sources('root_words_with_associated_words_cleaned.json'))
        ...
        with Progress(SpinnerColumn(), TextColumn("[progress.description]{task.description}"), console=Console()) as progress:
            for source in sources:
                ...
                if not os.path.exists(filename):
                    ...
                    parent_filename = os.path.join("..", "data", source["file"])
