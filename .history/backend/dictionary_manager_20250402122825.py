            ...
            for synonym in sense['synonyms']:
                if isinstance(synonym, dict) and 'word' in synonym:
                    ...
                    try:
                        ...
                        insert_relation(cur, word_id, syn_id, RelationshipType.SYNONYM.rel_value, source, metadata)
                    except Exception as e:
            ...
            for antonym in sense['antonyms']:
                if isinstance(antonym, dict) and 'word' in antonym:
                    try:
                        ...
                        insert_relation(cur, word_id, ant_id, RelationshipType.ANTONYM.rel_value, source, metadata)
                    except Exception as e:
            ...
            for hypernym in sense['hypernyms']:
                if isinstance(hypernym, dict) and 'word' in hypernym:
                    try:
                        ...
                        insert_relation(cur, word_id, hyper_id, RelationshipType.HYPERNYM.rel_value, source, metadata)
                    except Exception as e:
            ...
            for hyponym in sense['hyponyms']:
                if isinstance(hyponym, dict) and 'word' in hyponym:
                    try:
                        ...
                        insert_relation(cur, word_id, hypo_id, RelationshipType.HYPONYM.rel_value, source, metadata)
                    except Exception as e:
            ...
            for holonym in sense['holonyms']:
                if isinstance(holonym, dict) and 'word' in holonym:
                    try:
                        ...
                        insert_relation(cur, word_id, holo_id, RelationshipType.HOLONYM.rel_value, source, metadata)
                    except Exception as e:
            ...
            for meronym in sense['meronyms']:
                if isinstance(meronym, dict) and 'word' in meronym:
                    try:
                        ...
                        insert_relation(cur, word_id, mero_id, RelationshipType.MERONYM.rel_value, source, metadata)
                    except Exception as e:
            ...
            for derived in sense['derived']:
                if isinstance(derived, dict) and 'word' in derived:
                    try:
                        ...
                        insert_relation(cur, word_id, derived_id, RelationshipType.ROOT_OF.rel_value, source, metadata)
                    except Exception as e:
            ...
            for see_also in sense['see_also']:
                if isinstance(see_also, dict) and 'word' in see_also:
                    try:
                        ...
                        insert_relation(cur, word_id, see_also_id, RelationshipType.SEE_ALSO.rel_value, source, metadata)
                    except Exception as e:
        ...
        if 'forms' in entry:
            for form in entry.get('forms', []):
                ...
                try:
                    ...
                    insert_relation(cur, word_id, form_word_id, rel_type, source, metadata)
                except Exception as e:
                ...
                for derived in entry['derived']:
                    try:
                        if isinstance(derived, dict) and 'word' in derived:
                            ...
                            insert_relation(cur, word_id, derived_id, RelationshipType.ROOT_OF.rel_value, source_identifier, metadata)
                    except Exception as e:
                        logger.error(f"Error processing derived relation for word ID {word_id}: {str(e)}")
                ...
                for related in entry['related']:
                    try:
                        if isinstance(related, dict) and 'word' in related:
                            ...
                            insert_relation(cur, word_id, related_id, RelationshipType.RELATED.rel_value, source_identifier, metadata)
                    except Exception as e:
