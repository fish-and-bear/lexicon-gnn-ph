...
def create_app(testing=False):
    ...
    CORS(app, resources={
        r"/api/*": {
            ...
            "allow_headers": [
                ...
                "X-Requested-With", "Cache-Control", "X-Client-Version",
                "X-Client-Platform", "Accept-Encoding", "Access-Control-Request-Method",
                "Access-Control-Request-Headers", "Pragma", "If-Match", "If-None-Match"
            ],
            "expose_headers": [
    ...
    def after_request(response):
        ...
        response.headers.add('Access-Control-Allow-Headers', 'Content-Type,Authorization,Cache-Control,X-Requested-With,Accept,Origin,Accept-Encoding,Access-Control-Request-Method,Access-Control-Request-Headers,Pragma')
        response.headers.add('Access-Control-Allow-Methods', 'GET,PUT,POST,DELETE,OPTIONS')
        response.headers.add('Access-Control-Expose-Headers', 'Content-Range,X-Total-Count,X-Request-ID,X-RateLimit-Limit,X-RateLimit-Remaining,X-RateLimit-Reset')
