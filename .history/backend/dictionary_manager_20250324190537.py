...
def process_kaikki_jsonl(cur, filename: str):
    ...
    def process_entry(cur, entry: Dict):
        ...
        try:
            ...
            # We'll set autocommit back to original state outside this function
            pass
    ...
    try:
        ...
        logger.error(f"Error processing Kaikki JSONL: {str(e)}")
    finally:
            ...
            for source in source_list:
                try:
                    ...
                    if source == "root-words":
                        process_root_words(cur, "data/root-words-enhanced.json")
                    
                    elif source == "root-words-cleaned":
                        process_root_words_cleaned(cur, "data/root-words-cleaned.json")
                    
                    elif source == "tagalog-words":
                        process_tagalog_words(cur, "data/tagalog-words.json")
                    
                    elif source == "kwf-dictionary":
                        process_kwf_dictionary(cur, "data/kwf-dictionary.json")
                    
                    elif source == "kaikki":
                        process_kaikki_jsonl(cur, "data/kaikki-tl.jsonl")
