                    ...
                    for sense in entry_data['senses']:
                        ...
                        for synonym in synonyms:
                            try:
                                ...
                                # Handle any transaction errors at the synonym level
                                try:
                                    cur.connection.rollback()
                                except Exception as rollback_error:
                        ...
                        for variant in variants:
                            try:
                                ...
                                # Handle any transaction errors at the variant level
                                try:
                                    cur.connection.rollback()
                                except Exception as rollback_error:
                        ...
                        for reference in references:
                            try:
                                ...
                                # Handle any transaction errors at the reference level
                                try:
                                    cur.connection.rollback()
                                except Exception as rollback_error:
                    ...
                    for i, form in enumerate(affix_forms):
                        ...
                        if clean_form:
                            ...
                            try:
                                ...
                                # Handle any transaction errors at the affix level
                                try:
                                    cur.connection.rollback()
                                except Exception as rollback_error:
    ...
    try:
        ...
        for lemma, entry_data in tqdm(data.items(), desc="Processing Tagalog words"):
            ...
            try:
                ...
                # Don't continue with an aborted transaction
                cur.connection.rollback()
                # We don't need to call commit here as we're using independent transactions for each entry
