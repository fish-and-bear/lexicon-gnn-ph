...
def insert_etymology(
    ...
    Args:
        cur: Database cursor
        word_id: ID of the word to add etymology for
        etymology_text: Raw etymology text
        normalized_components: Normalized components of the etymology (comma-separated)
        etymology_structure: Structure of the etymology (e.g., borrowing, compound, etc.)
        language_codes: Comma-separated list of language codes involved
        sources: Source of this etymology information
    """
    ...
    try:
        ...
        logging.error(f"Error inserting etymology for word_id {word_id}: {e}")
        raise
