...
def get_word_comprehensive(word: str):
    ...
    try:
        ...
        # Serialize using the full WordSchema, EXCLUDING relations and pronunciations for diagnostics
        # Ensure previous exclusions for definitions/etymologies are removed first
