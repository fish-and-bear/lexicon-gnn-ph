...
class BaybayinRomanizer:
    ...
    def __init__(self):
        self.all_chars = {}
        # Combine all character mappings into a single dictionary for easy lookup
        for char_map in [self.VOWELS, self.CONSONANTS, self.VOWEL_MARKS, {self.VIRAMA.char: self.VIRAMA}, self.PUNCTUATION]:
