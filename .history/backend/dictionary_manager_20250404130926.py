...
POS_MAPPING = {
    ...
    # Affixes - Panlapi ('affix') - Note: Use 'affix' code from parts_of_speech table setup
    "affix": "affix",
    "panlapi": "affix",
    "aff": "affix",
    ...
    # Ligatures - Pang-angkop ('lig') - *Add this code if missing in parts_of_speech table*
    "ligature": "lig", # Needs 'lig' code in parts_of_speech table
    "linker": "lig",
    "pang-angkop": "lig",
    "Pang-angkop": "lig", # KWF Casing

    # Particles - Kataga ('part') - *Add this code if missing in parts_of_speech table*
    "particle": "part", # Needs 'part' code in parts_of_speech table
    "kataga": "part",
    "part": "part",

    # Numbers - Pamilang ('num') - *Add this code if missing in parts_of_speech table*
    ...
    # Expressions / Phrases ('expr') - *Add this code if missing in parts_of_speech table*
    ...
    # Punctuation ('punc') - *Add this code if missing in parts_of_speech table*
    ...
    "idm": "expr", # Map Idiom to Expression
    "col": "unc", # Map Colloquial to Uncategorized for now
    "syn": "unc", # Synonym tag is redundant with relations
    "ant": "unc", # Antonym tag is redundant
    ...
    "var": "unc", # Variant tag redundant with relations
