...
def with_transaction(commit=True):
    ...
    def decorator(func):
        ...
        def wrapper(cur, *args, **kwargs):
            ...
            # Get initial autocommit state - don't modify if already in a transaction
            try:
            ...
            if not in_transaction and original_autocommit:
                try:
            ...
            try:
                ...
                if started_transaction and original_autocommit is not None:
                    try:
                        ...
                        logger.debug(f"Restored connection autocommit to {original_autocommit}")
                    except psycopg2.Error as e:
...
def insert_relation(
    ...
    if relation_type.bidirectional:
        ...
        if not cur.fetchone():
            cur.execute(insert_query, (to_word_id, from_word_id, rel_value, sources, metadata_json))
