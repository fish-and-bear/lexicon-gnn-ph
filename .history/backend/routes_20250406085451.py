...
def _fetch_word_details(
    ...
    include_definition_relations: bool = True
) -> Optional[Word]:
    """
    ...
    if include_definitions:
        ...
        # Add join for categories and links when loading definitions
        options.append(joinedload(Word.definitions).joinedload(Definition.categories))
        options.append(joinedload(Word.definitions).joinedload(Definition.links))
    ...
    if include_definition_relations:
        options.append(selectinload(Word.definition_relations).joinedload('definition'))
