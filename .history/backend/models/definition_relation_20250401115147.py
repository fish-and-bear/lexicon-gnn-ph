...
class DefinitionRelation(BaseModel):
    ...
    # Relationships
    definition = db.relationship('Definition', back_populates='definition_relations', overlaps="related_words")
    related_word = db.relationship('Word', back_populates='definition_relations', overlaps="related_definitions")
