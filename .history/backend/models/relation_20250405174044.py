...
class Relation(BaseModel, StandardColumnsMixin):
    ...
    __table_args__ = (
        ...
        db.Index('idx_relations_metadata', 'data_metadata', postgresql_using='gin'),
        db.Index('idx_relations_metadata_strength', db.text("(data_metadata->>'strength')")),
    )
