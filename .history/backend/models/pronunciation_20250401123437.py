...
from sqlalchemy.orm import validates, hybrid_property
...
class Pronunciation(BaseModel):
    ...
    _metadata = db.Column('metadata', db.JSON)  # JSONB in PostgreSQL, using private name
    sources = db.Column(db.Text)
    
    # Create a hybrid property that maps to the metadata column
    @hybrid_property
    def pronunciation_metadata(self):
        return self._metadata
    
    @pronunciation_metadata.setter
    def pronunciation_metadata(self, value):
    ...
    def to_dict(self):
        ...
        return {
            ...
            'value': self.value,
            'tags': self.tags,
            'metadata': self.pronunciation_metadata,  # Keep the API response using 'metadata'
