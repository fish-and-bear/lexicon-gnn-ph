...
class Pronunciation(BaseModel):
    ...
    pronunciation_metadata = db.Column('metadata', db.JSON)  # Map attribute to 'metadata' DB column
    ...
    __table_args__ = (
        ...
        db.Index('idx_pronunciations_metadata', 'metadata', postgresql_using='gin')
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'value': self.value,
            'tags': self.tags or [],
            'metadata': self.pronunciation_metadata or {},
