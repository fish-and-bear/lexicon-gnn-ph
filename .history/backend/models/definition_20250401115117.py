...
class Definition(BaseModel):
    ...
    definition_relations = db.relationship('DefinitionRelation', back_populates='definition', lazy='dynamic', cascade='all, delete-orphan')
    related_words = db.relationship('Word', 
                                  ...
                                  overlaps="definition_relations,word.definition_relations")
