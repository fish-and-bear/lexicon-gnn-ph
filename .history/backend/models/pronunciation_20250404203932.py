...
class Pronunciation(BaseModel):
    ...
    pronunciation_metadata = db.Column(db.JSON)  # Maps directly to pronunciation_metadata column
    ...
    def metadata(self) -> Dict[str, Any]:
        ...
        return self.pronunciation_metadata or {}
    
    @metadata.setter
    def metadata(self, value: Dict[str, Any]) -> None:
        """Set metadata via the property."""
        self.pronunciation_metadata = value
    ...
    __table_args__ = (
        ...
        db.Index('idx_pronunciations_metadata', 'pronunciation_metadata', postgresql_using='gin')
    )
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'value': self.value,
            'tags': self.tags or [],
            'metadata': self.pronunciation_metadata or {},  # Return as 'metadata' in the API
