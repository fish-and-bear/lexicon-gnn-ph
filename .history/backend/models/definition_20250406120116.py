...
class Definition(BaseModel, BasicColumnsMixin):
    ...
    # Check if this column exists - if errors occur, comment this out
    try:
    ...
    def popularity_score(self):
        ...
        if hasattr(self.__class__, 'popularity_score') and isinstance(getattr(self.__class__, 'popularity_score'), db.Column):
            # Return the actual value if it's a column
