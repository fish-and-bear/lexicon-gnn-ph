...
class Word(BaseModel, TextSearchMixin, GINIndexMixin, TrigramSearchMixin):
    ...
    definitions = db.relationship('Definition', back_populates='word', lazy='dynamic', cascade='all, delete-orphan')
    etymologies = db.relationship('Etymology', back_populates='word', lazy='dynamic', cascade='all, delete-orphan')
    pronunciations = db.relationship('Pronunciation', back_populates='word', lazy='dynamic', cascade='all, delete-orphan')
    credits = db.relationship('Credit', back_populates='word', lazy='dynamic', cascade='all, delete-orphan')
    root_word = db.relationship('Word', remote_side=[id], back_populates='derived_words', cascade='save-update')
    derived_words = db.relationship('Word', back_populates='root_word', cascade='save-update')
    outgoing_relations = db.relationship('Relation', foreign_keys='Relation.from_word_id', back_populates='source_word', lazy='dynamic', cascade='all, delete-orphan')
    incoming_relations = db.relationship('Relation', foreign_keys='Relation.to_word_id', back_populates='target_word', lazy='dynamic', cascade='all, delete-orphan')
    root_affixations = db.relationship('Affixation', foreign_keys='Affixation.root_word_id', back_populates='root_word', lazy='dynamic', cascade='all, delete-orphan')
    affixed_affixations = db.relationship('Affixation', foreign_keys='Affixation.affixed_word_id', back_populates='affixed_word', lazy='dynamic', cascade='all, delete-orphan')
    definition_relations = db.relationship('DefinitionRelation', back_populates='related_word', lazy='dynamic', cascade='all, delete-orphan')
    related_definitions = db.relationship('Definition',
                                        ...
                                        overlaps="definition_relations,definitions")
