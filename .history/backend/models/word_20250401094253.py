...
class Word(db.Model):
    ...
    etymologies = db.relationship('Etymology', backref='word', lazy='dynamic')
    pronunciations = db.relationship('Pronunciation', backref='word', lazy='dynamic')
    credits = db.relationship('Credit', backref='word', lazy='dynamic')
    root_word = db.relationship('Word', remote_side=[id], backref='derived_words')
    outgoing_relations = db.relationship('Relation', foreign_keys='Relation.from_word_id', backref='source_word', lazy='dynamic')
    incoming_relations = db.relationship('Relation', foreign_keys='Relation.to_word_id', backref='target_word', lazy='dynamic')
    root_affixations = db.relationship('Affixation', foreign_keys='Affixation.root_word_id', backref='root_word', lazy='dynamic')
    affixed_affixations = db.relationship('Affixation', foreign_keys='Affixation.affixed_word_id', backref='affixed_word', lazy='dynamic') 