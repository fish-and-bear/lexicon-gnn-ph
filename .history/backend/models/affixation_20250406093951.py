...
class Affixation(BaseModel, BasicColumnsMixin):
    ...
    affixation_metadata = db.Column(JSONB, default=lambda: {})
    ...
    __table_args__ = (
        ...
        db.Index('idx_affixations_metadata', 'affixation_metadata', postgresql_using='gin')
    )
    ...
    @validates('affixation_metadata')
    def validate_metadata(self, key: str, value: Any) -> Dict:
