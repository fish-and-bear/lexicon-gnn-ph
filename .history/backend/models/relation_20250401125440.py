...
from .base_model import BaseModel, JSONEncodedDict
import json
...
class Relation(BaseModel):
    ...
    relation_data = db.Column('metadata', JSONEncodedDict, default={}, server_default='{}')  # JSONB in PostgreSQL
    ...
    def to_dict(self):
        ...
        return {
            ...
            'metadata': self.relation_data,  # Keep the API response using 'metadata'
