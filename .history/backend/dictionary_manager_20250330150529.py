...
def get_or_create_word_id(cur, lemma: str, language_code: str = "tl", check_exists: bool = False, **kwargs) -> int:
    ...
    try:
        ...
        cur.execute("""
            ...
            ) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, to_tsquery('simple', %s), %s, NOW(), NOW())
            RETURNING id
        """, (
            lemma, normalized_lemma, language_code, root_word_id,
            preferred_spelling, tags, has_baybayin, baybayin_form,
            romanized_form, search_text, sources
        ))
            ...
            try:
                ...
                cur.execute("""
                    ...
                    DO UPDATE SET 
                        ...
                        updated_at = CURRENT_TIMESTAMP
                    RETURNING id
                """, (lemma, norm, lang, "", search_text, standardized_source))
                ...
                try:
                    ...
                    for def_item in definitions:
                        ...
                        try:
                            ...
                            if def_id:
                                stats["definitions_added"] += 1
                                stats["examples_added"] += len(examples_data)
                        except Exception as e:
