...
class WordSchema(BaseSchema):
    ...
    tags = fields.String()
    idioms = fields.Dict(allow_none=True)
    source_info = fields.Dict(allow_none=True)
    word_metadata = fields.Dict(allow_none=True)  # Added to match model
    data_hash = fields.String()
    search_text = fields.String()
    badlit_form = fields.String()
    hyphenation = fields.Dict(allow_none=True)
