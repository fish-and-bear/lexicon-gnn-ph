        ...
        try:
                    ...
                    for def_entry in def_list:
                        try:
                            ...
                            try:
                                ...
                                for synonym in synonyms:
                                    ...
                                    if isinstance(synonym, str):
                                        ...
                                        # Extract term value and handle if it's a string or another type
                            ...
                            if see_refs:
                                ...
                                # Handle both single see reference and list of references
            ...
            if 'affixation' in entry and isinstance(entry['affixation'], list):
                ...
                for affix_entry in entry['affixation']:
                    # Handle both string affix_entry and dictionary affix_entry with 'term' key
                    affix_term = None
                    if isinstance(affix_entry, str):
                        affix_term = affix_entry.strip()
                        affix_type = 'unknown'
                    elif isinstance(affix_entry, dict) and 'term' in affix_entry:
                        # Extract term value and handle if it's a string or another type
                    ...
                    try:
                        ...
                        relation_type = RelationshipType.DERIVED_FROM if affix_type == 'root' else RelationshipType.ROOT_OF
                        
                        # For DERIVED_FROM, the formatted_word is derived from affix_term
                        # For ROOT_OF, the affix_term is derived from formatted_word
                        from_id = word_id if relation_type == RelationshipType.DERIVED_FROM else affix_id
                        to_id = affix_id if relation_type == RelationshipType.DERIVED_FROM else word_id
                            ...
                            try:
                                ...
                                for synonym in synonyms:
                                    ...
                                    if isinstance(synonym, str):
                                        ...
                                        synonym_term = synonym['term'].strip() if isinstance(synonym['term'], str) else None
                                    else:
                                        logger.warning(f"Skipping invalid synonym format for '{formatted_word}': {synonym}")
                                        continue
                                ...
                                for antonym in antonyms:
                                    ...
                                    if isinstance(antonym, str):
                                        ...
                                        antonym_term = antonym['term'].strip() if isinstance(antonym['term'], str) else None
                                    else:
                                        logger.warning(f"Skipping invalid antonym format for '{formatted_word}': {antonym}")
                                        continue
                                ...
                                for cross_ref in cross_refs:
                                    ...
                                    if isinstance(cross_ref, str):
                                        ...
                                        ref_term = cross_ref['term'].strip() if isinstance(cross_ref['term'], str) else None
                                    else:
                                        continue
                            ...
                            if see_refs:
                                ...
                                for see_ref in see_refs:
                                    ...
                                    if isinstance(see_ref, str):
                                        ...
                                        see_term = see_ref['term'].strip() if isinstance(see_ref['term'], str) else None
                                    else:
            ...
            if 'affixation' in entry and isinstance(entry['affixation'], list):
                ...
                for affix_entry in entry['affixation']:
                    ...
                    if isinstance(affix_entry, str):
                        ...
                        affix_term = affix_entry['term'].strip() if isinstance(affix_entry['term'], str) else None
                        affix_type = affix_entry.get('type', 'unknown')
                    else:
                        continue
                ...
                for rel_type, rel_terms in entry['related'].items():
                    ...
                    for rel_term_entry in rel_terms:
                        ...
                        if isinstance(rel_term_entry, str):
                            ...
                            rel_term = rel_term_entry['term'].strip() if isinstance(rel_term_entry['term'], str) else None
                        else:
                            continue
