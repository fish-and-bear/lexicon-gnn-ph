...
def process_tagalog_words(cur, filename: str):
    """
    Process tagalog-words.json with new structure:
    {
        "word1": {
            "word": "word1",
            "pronunciation": "...",
    ...
    try:
        ...
        for lemma, entry_data in tqdm(data.items(), desc="Processing Tagalog words"):
            try:
                ...
                # Extract tags from domains if present
                tags = []
                ...
                if 'etymology' in entry_data and entry_data['etymology']:
        ...
        logger.info(f"Added {definitions_added} definitions and {relations_added} relationships")
                
    except Exception as e:
        logger.error(f"Error processing tagalog-words.json: {str(e)}")
