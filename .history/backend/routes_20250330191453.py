...
def get_word(word, **params):
    ...
    try:
        ...
        if language_code not in ['tl', 'ceb', 'chv']:
            language_code = 'tl'
        ...
        word_data = {
            ...
            "language_code": word_obj.language_code,
        ...
        if include_relations:
            ...
            for rel in word_obj.relations_from:
                ...
                if rel_type in ['synonym', 'equals']:
                    relations_data["synonyms"].append(target_word)
                elif rel_type == 'antonym':
                    relations_data["antonyms"].append(target_word)
                elif rel_type in ['variant', 'spelling_variant', 'regional_variant']:
                    relations_data["variants"].append(target_word)
                elif rel_type == 'derived_from':
                    relations_data["derived_from"].append(target_word)
                elif rel_type == 'hypernym':
                    relations_data["hypernyms"].append(target_word)
                elif rel_type == 'hyponym':
                    relations_data["hyponyms"].append(target_word)
                elif rel_type in ['related', 'similar', 'compare_with', 'see_also']:
                    relations_data["related"].append(target_word)
            ...
            for rel in word_obj.relations_to:
                ...
                if rel_type == 'derived_from':
                    relations_data["root_of"].append(source_word)
                    ...
                    if source_word not in relations_data["synonyms"] and source_word not in relations_data["variants"]:
                        relations_data["related"].append(source_word)
