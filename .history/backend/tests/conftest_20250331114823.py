...
from backend.models import (
    db, PartOfSpeech, Word, Definition, Etymology, Relation
)
...
def _setup_test_data():
    ...
    try:
        ...
        aso_def = Definition(
            ...
            examples=json.dumps([{'text': 'Ang aso ay tumatahol.', 'translation': 'The dog is barking.'}]),
            meta_info=json.dumps({'quality_score': 0.9}),
            sources='dictionary'
        )
        ...
        tuta_def = Definition(
            ...
            standardized_pos=noun,
            examples=json.dumps([{'text': 'Ang tuta ay naglalaro.', 'translation': 'The puppy is playing.'}]),
            meta_info=json.dumps({'quality_score': 0.85}),
            sources='dictionary'
        )
        ...
        tahol_def = Definition(
            ...
            examples=json.dumps([{'text': 'Tumatahol ang aso.', 'translation': 'The dog is barking.'}]),
            meta_info=json.dumps({'quality_score': 0.8}),
            sources='dictionary'
        )
