...
class WordQuerySchema(Schema):
    ...
    language_code = fields.Str(validate=validate.OneOf(['tl', 'ceb', 'chv']), default='tl')
...
class SearchQuerySchema(Schema):
    ...
    language = fields.Str(validate=validate.OneOf(['tl', 'ceb', 'chv']), default='tl')
    include_baybayin = fields.Bool(default=True)
