...
export interface RawEtymology {
  ...
  created_at?: string;
  updated_at?: string;
  etymology_data?: Record<string, any> | null;
  etymology_metadata?: Record<string, any> | null;
}
...
export interface Etymology extends Omit<RawEtymology, 'language_codes' | 'sources' | 'normalized_components'> {
  ...
  languages: string[];
  sources: string[];
  etymology_data?: Record<string, any>;
}
...
export interface Relation {
  ...
  relation_data?: Record<string, any> | string | null;
  relation_metadata?: Record<string, any> | string | null;
  sources?: string | null;
...
export interface Affixation {
  ...
  affixation_data?: Record<string, any> | null;
  affixation_metadata?: Record<string, any> | null;
}
