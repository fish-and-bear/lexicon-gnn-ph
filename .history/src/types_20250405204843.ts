...
export interface Pronunciation {
  ...
  pronunciation_metadata?: Record<string, any> | string | null;
  sources?: string | null;
  created_at?: string | null;
  updated_at?: string | null;
}

export interface Pronunciation extends Omit<Pronunciation, 'sources' | 'tags' | 'pronunciation_metadata'> {
  sources: string[];
  tags: Record<string, any>;
  pronunciation_metadata: Record<string, any>;
  ipa?: string;
  audio_url?: string;
}
