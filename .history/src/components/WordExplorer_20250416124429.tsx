...
const WordExplorer: React.FC = () => {
  ...
  return (
    <div className={`word-explorer ${theme} ${isLoading ? 'loading' : ''}`}>
      ...
      <main>
        {isWideLayout ? (
          <PanelGroup direction="horizontal" autoSaveId="wordExplorerLayout" style={{ width: '100%', height: '100%' }}>
            <Panel defaultSize={60} minSize={30} order={1}>
              {/* Graph Container Content */}
              <div className="graph-container" style={{ height: '100%', width: '100%', borderRight: 'none' }}>
