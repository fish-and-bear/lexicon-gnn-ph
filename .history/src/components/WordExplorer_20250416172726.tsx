  ...
  useEffect(() => {
    if (wordData && selectedWordInfo && wordData.id === selectedWordInfo.id) {
      ...
      const hasNewRelations = 
        (wordData.incoming_relations?.length > 0 && (!selectedWordInfo.incoming_relations || selectedWordInfo.incoming_relations.length === 0)) ||
        (wordData.outgoing_relations?.length > 0 && (!selectedWordInfo.outgoing_relations || selectedWordInfo.outgoing_relations.length === 0));
