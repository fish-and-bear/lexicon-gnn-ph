...
const WordExplorer: React.FC = () => {
  ...
  const handleNetworkChange = useCallback((newNetwork: WordNetwork) => {
    console.log("Network changed (e.g., layout updated)", newNetwork);
  }, []);
          ...
          <div className="graph-content">
            ...
            {!isLoading && wordNetwork && (
              <WordGraph
                ...
                mainWord={mainWord}
                onNodeClick={handleNodeClickDetailed}
