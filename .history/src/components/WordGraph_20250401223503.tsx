  ...
  const createLinks = useCallback((g: d3.Selection<SVGGElement, unknown, null, undefined>, linksData: CustomLink[]) => {
      ...
      return g.append("g")
        ...
        .join(
            ...
            update => update
                .call(update => update.transition().duration(300)), // Basic update transition
            exit => exit
        ...
        .join(
            enter => {
                ...
                nodeGroup.append("circle")
                    ...
                    // Restore simpler default stroke
      ...
      nodeSelection
        .on("click", (event, d) => {
            ...
            d3.selectAll(".node").classed("selected connected", false)
                ...
                .attr("transform", n => `translate(${(n as CustomNode).x ?? 0},${(n as CustomNode).y ?? 0}) scale(1)`) // Ensure no scaling
                .style("opacity", 0.15);
            ...
            targetNodeElement.classed("selected", true)
                .transition().duration(200)
                .style("opacity", 1)
                .attr("transform", `translate(${d.x ?? 0},${d.y ?? 0}) scale(1)`); // Ensure no scaling
                // Apply selected border style via mouseout logic
        ...
        .on("mouseout", (event, d_unknown) => {
            ...
            nodeElement.select<SVGCircleElement>("circle")
                ...
                .attr("stroke-width", (n: CustomNode) => n.id === selectedNodeId ? 2.5 : (n.pinned ? 3 : 1))
