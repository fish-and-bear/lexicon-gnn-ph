  ...
  const renderDefinitionsTab = () => {
    ...
    return (
      <Box sx={{ pt: theme.spacing(1) }}>
        {/* Baybayin section added here - below the main word */}
        {(wordInfo.has_baybayin && wordInfo.baybayin_form) || convertedBaybayin ? (
          <Box sx={{ mb: theme.spacing(3), pb: theme.spacing(2), borderBottom: `1px solid ${alpha(theme.palette.divider, 0.6)}` }}>
            <Typography variant="subtitle2" sx={{ fontWeight: 600, mb: 1 }}>
              {wordInfo.has_baybayin ? "Baybayin Script" : "Converted to Baybayin"}
            </Typography>
            <div 
            ...
            {!wordInfo.has_baybayin && convertedBaybayin && (
              <Typography variant="caption" sx={{ display: 'block', mt: 0.5, fontStyle: 'italic', color: theme.palette.text.secondary }}>
