  ...
  return (
    <ControlContainer className={className}>
      <SliderContainer>
        <ControlLabel>
          Depth
          <Tooltip title="Steps away from main word" arrow placement="bottom" enterDelay={700} leaveDelay={200}>
      ...
      <SliderContainer>
        <ControlLabel>
          Breadth
          <Tooltip title="Relations per word" arrow placement="bottom" enterDelay={700} leaveDelay={200}>
            <InfoIcon fontSize="small" />
          </Tooltip>
