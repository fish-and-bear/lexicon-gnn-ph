...
const WordExplorer: React.FC = () => {
  ...
  // Assume that 'selectedWordInfo' is the currently selected word (already defined in the component state).
  const { data: wordNetwork, isLoading: networkLoading, error: networkError } = useWordNetwork(mainWord, { depth, breadth, include_affixes: true, include_etymology: true, cluster_threshold: 0.3 });
