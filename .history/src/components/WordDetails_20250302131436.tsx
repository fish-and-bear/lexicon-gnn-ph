        ...
        <div className="component-organization">
          ...
          <div className="component-categories">
            {protoComponents.length > 0 && (
              <div className="component-category category-proto">
                <h5>Proto-Language Forms</h5>
                <div className="component-tags-organized">
                  {protoComponents.map((component, idx) => (
                    <span 
                      key={idx} 
                      className="component-tag-organized proto"
                      onClick={() => onWordClick(component)}
                    >
                      {component}
                      {componentFrequency[component] > 1 && (
                        <span className="tag-info">{componentFrequency[component]}</span>
                      )}
                    </span>
                  ))}
                </div>
            ...
            {inheritedComponents.length > 0 && (
              <div className="component-category category-inherited">
                <h5>Inheritance Paths</h5>
                <div className="component-tags-organized">
                  {inheritedComponents.map((component, idx) => (
                    <span 
                      key={idx} 
                      className="component-tag-organized inherited"
                      onClick={() => onWordClick(component)}
                    >
                      {component}
                      {componentFrequency[component] > 1 && (
            ...
            {variantComponents.length > 0 && (
              <div className="component-category category-variants">
                <h5>Variants & Earlier Forms</h5>
                <div className="component-tags-organized">
                  {variantComponents.map((component, idx) => (
                    <span 
                      key={idx} 
                      className="component-tag-organized variant"
                      onClick={() => onWordClick(component)}
                    >
                      {component}
                      {componentFrequency[component] > 1 && (
            ...
            {otherComponents.length > 0 && (
              <div className="component-category category-components">
                <h5>Other Components</h5>
                <div className="component-tags-organized">
                  {otherComponents.map((component, idx) => (
                    <span 
                      key={idx} 
                      className="component-tag-organized"
                      onClick={() => onWordClick(component)}
                    >
                      {component}
                      {componentFrequency[component] > 1 && (
          ...
          {/* Timeline Visualization (if we have enough data) */}
          {hasTimelineData && (
            <div className="etymology-timeline">
              ...
              {protoComponents.length > 0 && (
                <div className="timeline-node">
                  <div className="timeline-era">Proto-Language Era</div>
                  <div className="timeline-components">
                    ...
                    {protoComponents.length > 3 && (
                      <span className="component-tag-organized proto">
                        +{protoComponents.length - 3} more
                      </span>
                    )}
                  </div>
                </div>
              ...
              {inheritedComponents.length > 0 && (
                <div className="timeline-node">
                  <div className="timeline-era">Inheritance & Borrowing</div>
                  <div className="timeline-components">
                    ...
                    {inheritedComponents.length > 3 && (
                      <span className="component-tag-organized inherited">
                        +{inheritedComponents.length - 3} more
                      </span>
                    )}
                  </div>
                </div>
              ...
              {variantComponents.length > 0 && (
                <div className="timeline-node">
                  <div className="timeline-era">Earlier Forms & Variants</div>
                  <div className="timeline-components">
                    ...
                    {variantComponents.length > 3 && (
                      <span className="component-tag-organized variant">
                        +{variantComponents.length - 3} more
                      </span>
                    )}
                  </div>
                </div>
              ...
              <div className="timeline-node">
                <div className="timeline-era">Current Word</div>
                <div className="timeline-components">
                  <span className="component-tag-organized current">
                    {word.lemma}
                  </span>
                </div>
              </div>
          ...
          {protoComponents.length > 0 && (
            <div className="component-relationships">
              <h4>Component Relationships</h4>
              <div className="relationship-diagram">
                {protoComponents.length > 0 && (
                  <div className="relationship-level">
                    {protoComponents.slice(0, 3).map((component, idx) => (
                      <div 
                        key={idx} 
                        className="relationship-node proto"
                        onClick={() => onWordClick(component)}
                      >
                        {component}
                      </div>
                    ))}
                    <div className="relationship-connector connector-vertical"></div>
                  </div>
                )}
                ...
                {inheritedComponents.length > 0 && (
                  <div className="relationship-level">
                    {inheritedComponents.slice(0, 3).map((component, idx) => (
                      <div 
                        key={idx} 
                        className="relationship-node inherited"
                        onClick={() => onWordClick(component)}
                      >
                        {component}
                      </div>
                ...
                <div className="relationship-level">
                  <div 
                    className="relationship-node current"
                    onClick={() => onWordClick(word.lemma)}
                  >
                    {word.lemma}
                  </div>
                </div>
