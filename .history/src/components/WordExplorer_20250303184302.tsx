...
const WordExplorer: React.FC = () => {
  ...
  const fetchWordNetworkData = useCallback(async (word: string, depth: number = 2, breadth: number = 10) => {
    try {
      setIsLoading(true);
      console.log('Fetching word network for:', word, 'with depth:', depth, 'breadth:', breadth);
      ...
      console.log('Received word network data:', data);
      ...
      if (!networkData.nodes.find(n => n.word === word)) {
