          ...
          <div>
            {selectedWordInfo ? (
              <WordDetails 
                ...
                onWordLinkClick={handleWordLinkClick} // Pass handler
                onEtymologyNodeClick={handleWordLinkClick} // Reuse handler for etymology nodes
              />
              ...
              <div>
                ...
                <ul>
                  {searchResults.map(word => (
                    <li key={word.id} 
                        onClick={() => handleWordLinkClick(word.id)} // Make results clickable
