...
import BaybayinStatistics from "./BaybayinStatistics";
import BaybayinSearch from "./BaybayinSearch";
import BaybayinConverter from "./BaybayinConverter";
    ...
    <div className={`word-explorer ${theme} ${isLoading ? 'loading' : ''}`}>
      ...
      <Box sx={{ borderBottom: 1, borderColor: 'divider', mt: 2 }}>
        ...
        >
          ...
          <Tab label="Baybayin Search" />
          <Tab label="Baybayin Converter" />
          <Tab label="Baybayin Statistics" />
        </Tabs>
      </Box>
      ...
      {/* Baybayin Converter tab */}
      <TabPanel value={tabValue} index={2}>
        <BaybayinConverter />
      </TabPanel>

      {/* Baybayin Statistics tab */}
