  ...
  useEffect(() => {
    const checkApiConnection = async () => {
      try {
        ...
        if (!isConnected) {
          console.log("Initial API connection failed, retrying in 2 seconds...");
          ...
          setTimeout(async () => {
            ...
            if (!retryResult) {
              setError("Cannot connect to the API server. Please check your network connection and try again.");
            } else {
        ...
        setError("Error checking API connection. Please try again later.");
      }
    };
