...
const darkModeRelationColors: Record<string, string> = {
  ...
  etymology: "#ff4d4d",  // Vivid red
  cognate: "#ff7b5a",    // Saturated orange
  
  // Meaning group - Brighter blues
  synonym: "#64b5f6",    // Brighter blue
  related: "#67daff",    // Vivid light blue
  antonym: "#4d6cff",    // Vibrant dark blue
  similar: "#b6e1e4",    // Light blue
  
  // Form group - Brighter purples
  variant: "#a875ff",    // Brighter purple
  spelling: "#b76afc",   // Bright purple
  abbreviation: "#8467d7", // Saturated purple
  form_of: "#9c7ad0",    // Brighter blue-purple
