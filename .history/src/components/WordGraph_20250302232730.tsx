...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  const renderTooltip = useCallback(() => {
    ...
    // Debug what's available in the definitions
    console.log(`Definitions for ${hoveredNode.id}:`, {
      infoDefinitions,
      nodeDefinitions
    });
    ...
    // If we still don't have a definition, check if there's a gloss or type field
    if (definitionText === "No definition available" && nodeData) {
      if (nodeData.gloss && typeof (nodeData as any).gloss === 'string') {
        definitionText = (nodeData as any).gloss;
