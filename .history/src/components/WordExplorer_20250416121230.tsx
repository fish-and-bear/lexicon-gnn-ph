        ...
        {isWideLayout ? (
          <PanelGroup direction="horizontal" autoSaveId="wordExplorerLayout">
            ...
            <Panel defaultSize={40} minSize={25} order={2}>
              {/* Details Container Content - Pass correct wordInfo */}
              <div ref={detailsContainerRef} className="details-container" style={{ height: '100%', borderLeft: 'none' }}>
                {isLoading && <div className="loading-spinner">Loading Details...</div>} 
                {!isLoading && selectedWordInfo && (
                  <WordDetails 
                    wordInfo={selectedWordInfo} // Pass the selectedWordInfo directly 
