...
import { WordNetwork, WordInfo, SearchResult, SearchOptions, Etymology, Statistics, Definition, SearchWordResult } from "../types";
...
const WordExplorer: React.FC = () => {
  ...
  const fetchEtymologyTree = useCallback(async (wordId: number): Promise<Etymology | null> => {
