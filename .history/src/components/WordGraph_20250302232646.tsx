...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  const renderTooltip = useCallback(() => {
    ...
    // If we still don't have a definition, check if there's a glossText or type field
    if (definitionText === "No definition available" && nodeData) {
      if (nodeData.gloss && typeof nodeData.gloss === 'string') {
        definitionText = nodeData.gloss;
