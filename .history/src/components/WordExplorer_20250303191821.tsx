...
import { WordNetwork, WordNetworkGraph, WordNetworkLists, WordInfo, SearchResult, SearchOptions, EtymologyTree, Statistics, Definition } from "../types";
...
const WordExplorer: React.FC = () => {
  ...
  const fetchWordNetworkData = useCallback(async (word: string, depth: number = 2, breadth: number = 10) => {
    try {
      ...
      const now = Date.now();
      for (const [key, value] of networkCache.current.entries()) {
