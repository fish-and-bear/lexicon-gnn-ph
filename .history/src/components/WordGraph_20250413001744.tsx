...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  useEffect(() => {
    ...
    const legendWidth = Math.max(maxCategoryWidth, maxTextWidth + textPadding + 15) + (legendPadding * 2);
