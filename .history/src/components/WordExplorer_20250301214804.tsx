...
import { WordNetwork, WordInfo, SearchResult, SearchOptions, EtymologyTree, Statistics } from "../types";
      ...
      <div className="statistics-section">
        ...
        <div className="statistics-grid">
          <div className="stat-card">
            <h4>Words</h4>
            <p className="stat-number">{statistics.words_count || 0}</p>
          </div>
          <div className="stat-card">
            <h4>Definitions</h4>
            <p className="stat-number">{statistics.definitions_count || 0}</p>
          </div>
          <div className="stat-card">
            <h4>Examples</h4>
            <p className="stat-number">{statistics.examples_count || 0}</p>
          </div>
          <div className="stat-card">
            <h4>Languages</h4>
            <p className="stat-number">{statistics.languages_count || 0}</p>
          </div>
        </div>
      </div>
    );
      ...
      <div className="baybayin-section">
        ...
        <div className="baybayin-grid">
          {baybayinWords.map((word, index) => (
            <div key={index} className="baybayin-card" onClick={() => handleNodeClick(word.word)}>
