              ...
              {isExpanded && (
                <div className="relation-list">
                  {relationsOfType.map((relatedItem, index) => {
                    ...
                    const relatedWord = relatedItem.direction === 'out' ? relatedItem.target_word : relatedItem.source_word;
                    ...
                    ) : null; // Render nothing if word/lemma is missing
                  })}
                </div>
              )}
            </div>
