        ...
        entry.append("rect")
          ...
          .on("click", function(this: SVGRectElement) {
            ...
            setFilteredRelationships(prev => {
              ...
              const svg = d3.select(this.parentNode as SVGGElement).select(function() {
                return this.parentNode;
              });
              
              console.log(`Applying filters to ${svg.selectAll<SVGGElement, CustomNode>(".node").size()} nodes and ${svg.selectAll<SVGLineElement, CustomLink>(".link").size()} links`);
              
              // Apply filtering immediately for responsive UI
              const allNodes = svg.selectAll<SVGGElement, CustomNode>(".node");
              const allLinks = svg.selectAll<SVGLineElement, CustomLink>(".link");
