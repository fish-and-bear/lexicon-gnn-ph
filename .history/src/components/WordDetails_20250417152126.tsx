  ...
  const renderRelationsTab = () => {
              ...
              <Box mt={2}>
                <Button 
                  ...
                  onClick={() => {
                    ...
                    const forcedRelations = createRelationsFromNetwork();
    ...
    function createRelationsFromNetwork() {
      ...
      const mainNodeId = semanticNetworkNodes.find(n => 
        n.label === mainWord || n.word === mainWord || n.type === 'main'
      )?.id;
      ...
      semanticNetworkLinks.forEach(link => {
        ...
        // Skip if neither incoming nor outgoing (shouldn't happen in a proper network)
        if (!isOutgoing && !isIncoming && mainNodeId) {
          return;
        }
        ...
        const connectedNode = semanticNetworkNodes.find(n => n.id === connectedNodeId);
