        ...
        <Box key={node.id} sx={{ ml: level * 2.5, mb: 1.5 }}>
          <Paper elevation={1} sx={{ p: 1.5, display: 'flex', alignItems: 'center', gap: 1.5, borderRadius: '8px', bgcolor: alpha(theme.palette.background.paper, 0.7) }}> {/* Use paper bg */}
            <Chip 
              ...
              size="small" 
              sx={{ fontWeight: 600, bgcolor: getNodeColor(node.language || 'associated', theme.palette.mode), color: getTextColorForBackground(getNodeColor(node.language || 'associated', theme.palette.mode)) }} // Pass theme mode to color utils - CORRECTED
            />
            <Link
              component="button"
