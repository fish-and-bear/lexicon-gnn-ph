  ...
  const setupNodeInteractions = useCallback((
      ...
      nodeSelection
        ...
        .on("mouseout", (event, d_unknown) => {
            ...
            // *** REMOVE complex border restoration logic from mouseout ***
            // Let the click handler manage the persistent selected/connected state.
            // const nodeElement = d3.select(event.currentTarget as Element);
            // const d = d_unknown as CustomNode;
            // const circleSelection = nodeElement.select<SVGCircleElement>("circle").data([d]);
            // circleSelection.transition("hover_border_width")... etc ...
            // circleSelection.transition("hover_border_color")... etc ...
        });
  }, [selectedNodeId, onNodeClick, getNodeRadius, getNodeColor, theme, nodeMap, tooltipTimeoutId, onNodeSelect]); // Added onNodeSelect, tooltipTimeoutId
