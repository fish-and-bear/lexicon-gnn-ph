  ...
  const updateGraph = useCallback(() => {
    ...
    try {
      ...
      const relationTypes = [
        ...
        { type: 'related', label: 'Related/Kaugnay' }, // Combined label
    ...
    return (
      ...
      >
        ...
        <div style={{ 
          ...
          Relationship: <span style={{ color: getNodeColor(hoveredNode.group) }}>{
            hoveredNode.group === "related" ? "Related/Kaugnay" : hoveredNode.group
          }</span>
        </div>
      </div>
    );
