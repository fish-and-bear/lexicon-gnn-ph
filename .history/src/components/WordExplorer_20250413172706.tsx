      ...
      <main>
        ...
        <div ref={detailsContainerRef} className="details-container">
          ...
          {!isLoading && selectedWordInfo && (
            <>
              {/* Add debugging code - will show in browser console */}
              {console.log("DEBUG - Passing data to WordDetails:", {
                id: selectedWordInfo.id,
                lemma: selectedWordInfo.lemma,
                hasIncomingRelations: Boolean(selectedWordInfo.incoming_relations),
                incomingRelationsCount: selectedWordInfo.incoming_relations?.length || 0,
                hasOutgoingRelations: Boolean(selectedWordInfo.outgoing_relations),
                outgoingRelationsCount: selectedWordInfo.outgoing_relations?.length || 0,
                sample: {
                  incoming: selectedWordInfo.incoming_relations?.[0] || null,
                  outgoing: selectedWordInfo.outgoing_relations?.[0] || null
                }
              })}
              <WordDetails 
