...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  useEffect(() => {
    ...
    // Create a more compact single-column legend
    ...
    const legendCols = 1; // Single column for better readability
    ...
    categories.forEach(category => {
      ...
      category.types.forEach(type => {
        ...
        entry.append("rect")
          .attr("width", legendItemWidth - (legendPadding * 2))
      ...
      // Add small spacing after each category
      yPos += 5;
    });
