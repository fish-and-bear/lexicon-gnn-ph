    ...
    <div className={`word-details-container ${theme}`}>
      <div className={`word-details ${theme}`}>
        ...
        <div className={`word-tabs ${theme}`}>
          ...
          >
            <span className={`tab-icon ${theme}`}>
              <span className="material-icons">menu_book</span>
            </span> 
            Definitions
            {wordInfo.definitions && (
              <span className={`tab-count ${theme}`}>{wordInfo.definitions.length}</span>
            )}
          </div>
          ...
          >
            ...
            {wordInfo.relations && Object.keys(wordInfo.relations).length > 0 && (
              <span className={`tab-count ${theme}`}>
                {Object.values(wordInfo.relations).flat().length}
              </span>
            )}
          </div>
