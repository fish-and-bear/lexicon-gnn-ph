        ...
        {isWideLayout ? (
          <PanelGroup direction="horizontal" autoSaveId="wordExplorerLayout">
            <Panel defaultSize={60} minSize={30} order={1}>
              <div className="graph-container" style={{ height: '100%', borderRight: 'none' }}> {/* Override border */} 
            ...
            <Panel defaultSize={40} minSize={25} order={2}>
              <div ref={detailsContainerRef} className="details-container" style={{ height: '100%', borderLeft: 'none' }}> {/* Override border */} 
          ...
          // Mobile/Stacked Layout (Original structure for CSS to handle)
          <>
