...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  const renderRelationsTab = () => {
    ...
    const useSemanticNetwork = 
      ((incoming_relations.length === 0 && combinedOutgoingRelations.length === 0) || hasError) && 
    ...
    const hasStandardRelations = (incoming_relations.length > 0 || combinedOutgoingRelations.length > 0) && !hasError;
