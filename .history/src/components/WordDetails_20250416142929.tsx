  ...
  const renderHeader = () => {
    ...
    return (
      ...
      <Box sx={{ 
        ...
        {/* Pronunciation (IPA) - Always show this section */}
        <Typography 
          variant="h6" 
          sx={{ 
            fontStyle: 'italic', 
        ...
        >
          {ipaPronunciation ? `/${ipaPronunciation.value}/` : 'No pronunciation available'}
        </Typography>

        {/* Baybayin - Always show this section */}
        <Box sx={{ my: theme.spacing(2) }}>
          ...
          >
            {wordInfo.baybayin_form && wordInfo.baybayin_form.trim() !== '' 
              ? wordInfo.baybayin_form 
              : 'No baybayin form available'}
          </div>
        </Box>
