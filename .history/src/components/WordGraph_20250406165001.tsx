      ...
      <div className="controls-container">
        ...
        <div className="graph-controls">
          <div className="slider-container">
             ...
             <Slider value={depth} onChange={handleDepthChange} aria-labelledby="depth-slider" step={1} marks min={1} max={3} size="small" sx={{ width: 100 }}
                title={`Set relationship depth (Current: ${depth})`}/>
          </div>
          <div className="slider-container">
             <Typography variant="caption" sx={{ mr: 1 }}>Breadth: {breadth}</Typography>
             <Slider value={breadth} onChange={handleBreadthChange} aria-labelledby="breadth-slider" step={1} marks min={1} max={20} size="small" sx={{ width: 100 }}
                title={`Set relationship breadth (Current: ${breadth})`}/>
          </div>
        </div>
      </div>
      {renderTooltip()}
