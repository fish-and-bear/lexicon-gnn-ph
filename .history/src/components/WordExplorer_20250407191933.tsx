...
const WordExplorer: React.FC = () => {
  ...
  const handleSuggestionClick = useCallback((suggestion: SearchWordResult) => {
    const wordToLoad = suggestion.lemma;
    console.log(`Selected suggestion: ${wordToLoad}`);
...
const WordExplorer: React.FC = () => {
  ...
  // Node selection handler
  const handleSuggestionClick = useCallback((word: SearchWordResult) => {
    if (!word || !word.lemma) return;
    
    const selectedWord = word.lemma;
