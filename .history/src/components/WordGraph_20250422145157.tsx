  ...
  useEffect(() => {
    ...
    if (!isMobile) {
      ...
      const legendContainer = svg.append("g")
        .attr("class", "legend")
        // Change transform to position from top-left
        .attr("transform", `translate(20, 20)`); // Position 20px from top, 20px from left
      ...
      // REMOVE: Adjustment based on calculated width (no longer needed for top-left positioning)
