...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  const renderHeader = () => {
    ...
    // Enhanced colors for better contrast in both modes
    const headerBgColor = isDarkMode
      ? alpha(graphColors.main, 0.75) // Darker background in dark mode for more saturation
      : alpha(graphColors.main, 0.15); // Slightly more visible in light mode
    ...
    return (
      // Enhanced header box with shadow for better visual hierarchy
      <Box sx={{ 
        ...
        {ipaPronunciation && (
          <Typography 
            ...
            sx={{ 
              ...
              px: 1,
              borderRadius: '4px',
              bgcolor: isDarkMode ? alpha('#000', 0.2) : alpha('#fff', 0.5),
        ...
        <Stack 
          ...
          sx={{ 
            mt: 3,
            pt: 2,
            borderTop: `1px solid ${isDarkMode ? alpha('#fff', 0.1) : alpha('#000', 0.05)}`,
          }}
        >
              ...
              <Chip
                ...
                sx={{
                  ...
                  borderColor: isDarkMode 
                    ? alpha(headerTextColor, 0.3) 
                    : alpha(mainColor, 0.4),
                  bgcolor: isDarkMode 
                    ? alpha(headerTextColor, 0.1) 
                  ...
                  '&:hover': {
                    bgcolor: isDarkMode 
                      ? alpha(headerTextColor, 0.2) 
                      : alpha(mainColor, 0.1),
                    borderColor: isDarkMode 
                      ? alpha(headerTextColor, 0.4) 
                      : alpha(mainColor, 0.5),
                  }
                }}
                variant="outlined"
