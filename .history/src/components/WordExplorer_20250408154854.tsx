...
const WordExplorer: React.FC = () => {
  ...
  const handleMouseMove = useCallback((e: MouseEvent) => {
    ...
    const newWidth = Math.max(200, Math.min(mainWidth * 0.8, mainWidth - e.clientX + mainRect.left));
    ...
    <div className={`word-explorer ${theme} ${isLoading ? 'loading' : ''}`}>
      ...
      <main>
        ...
        <div 
          ...
          style={{
            left: mainContainerRef.current 
              ? `${mainContainerRef.current.getBoundingClientRect().width - detailsWidth}px`
              : 'auto'
          }}
        />
