        ...
        <div className={`metadata-section ${theme}`}>
          ...
          {showMetadata && (
            <div className={`metadata-content ${theme}`}>
              ...
              {word.added_at && (
                <div className={`metadata-item ${theme}`}>
                  <span className={`metadata-label ${theme}`}>Added:</span>
                  <span className={`metadata-value ${theme}`}>{formatDate(word.added_at)}</span>
                </div>
              )}
              {word.updated_at && (
                <div className={`metadata-item ${theme}`}>
              ...
              {word.source && (
                <div className={`metadata-item ${theme}`}>
                  <span className={`metadata-label ${theme}`}>Source:</span>
                  <span className={`metadata-value ${theme}`}>{word.source}</span>
                </div>
              )}
              {word.contributors && word.contributors.length > 0 && (
                <div className={`metadata-item ${theme}`}>
                  <span className={`metadata-label ${theme}`}>Contributors:</span>
                  <span className={`metadata-value ${theme}`}>{word.contributors.join(', ')}</span>
                </div>
              )}
            </div>
          )}
      ...
      <div className={`etymology-container ${theme}`}>
        ...
        <div className={`section-content ${theme}`}>
          <div className={`etymology-content ${theme}`}>
            <div className={`etymology-origin ${theme}`}>
              <h4 className={`origin-title ${theme}`}>Origin:</h4>
              <p className={`origin-text ${theme}`}>{word.etymologies[0].text}</p>
            </div>
            
            {word.etymologies[0].history && (
              <div className={`etymology-history ${theme}`}>
                <h4 className={`history-title ${theme}`}>History:</h4>
                <div className={`history-content ${theme}`}>
                  <p className={`history-text ${theme}`}>{word.etymologies[0].history}</p>
                </div>
              </div>
            )}
            
            {word.etymologies[0].related_languages && word.etymologies[0].related_languages.length > 0 && (
              <div className={`related-languages ${theme}`}>
                <h4 className={`languages-title ${theme}`}>Related Languages:</h4>
                <ul className={`languages-list ${theme}`}>
                  {word.etymologies[0].related_languages.map((lang, index) => (
                    <li key={index} className={`language-item ${theme}`}>
                      <span className={`language-name ${theme}`}>{lang.language}:</span>
                      <span className={`language-word ${theme}`}>{lang.word}</span>
                    </li>
                  ))}
                </ul>
              </div>
            ...
            {word.etymologies[0].cognates && word.etymologies[0].cognates.length > 0 && (
              <div className={`cognates ${theme}`}>
                <h4 className={`cognates-title ${theme}`}>Cognates:</h4>
                <div className={`cognate-tags ${theme}`}>
                  {word.etymologies[0].cognates.map((cognate, index) => (
                    <span 
                      key={index}
                      className={`cognate-tag ${theme}`}
                      onClick={() => onWordClick(cognate)}
                    >
                      {cognate}
                    </span>
                  ))}
