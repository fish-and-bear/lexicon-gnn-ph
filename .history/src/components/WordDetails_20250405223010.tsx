...
import { fetchWordDetails } from "../api/wordApi";
...
import {
  ...
  Language as LanguageIcon, // Keep LanguageIcon from MUI
...
// const isColorLight = useMemo(() => checkIsColorLight(theme.palette.background.paper), [theme.palette.background.paper]);
const textColor = useTheme().palette.text.primary; // Directly use theme text color
