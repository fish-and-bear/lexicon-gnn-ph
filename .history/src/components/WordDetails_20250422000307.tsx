...
interface WordDetailsProps {
  wordData: WordInfo; // Corrected prop name based on previous fix
  etymologyTree: any;
  isLoadingEtymology: boolean;
  etymologyError: string | null;
  // onWordLinkClick: (word: string) => void; // Replaced by onWordClick
  // onEtymologyNodeClick: (node: any) => void; // Seems unused
  onFetchEtymology: (wordId: number) => Promise<EtymologyTree | null>; // Added back based on previous fix
  onWordClick: (word: string | WordSuggestion | null) => void; // Added back based on previous fix
...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  isLoadingEtymology,
  etymologyError,
  onFetchEtymology, // Added back
  onWordClick, // Added back
