...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  if (!wordInfo?.id) {
    ...
    return (
        <Paper elevation={0} sx={{ p: 3, height: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: 'transparent' }}>
            ...
            <Box sx={{ 
              ...
              >
                ...
                <TabPanel value={tabValue} index={3}>
                  <EtymologyTree
                    data={etymologyTreeData}
                    isLoading={isEtymologyTreeLoading}
                    error={etymologyTreeError}
                    mainWordId={wordInfo.id}
                  />
                </TabPanel>
