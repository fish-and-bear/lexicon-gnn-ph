        ...
        try {
          ...
          try {
            ...
            if (result && result.baybayin) {
              ...
              setConvertedBaybayin('unavailable');
            }
          } catch (apiError) {
            console.error('WordDetails: API error during baybayin conversion:', apiError);
            setConvertedBaybayin('unavailable');
          }
        } catch (error) {
  ...
  const renderHeader = () => {
    ...
    return (
      ...
      <Box sx={{ 
        ...
        {(wordInfo.has_baybayin && wordInfo.baybayin_form) || (convertedBaybayin && convertedBaybayin !== 'unavailable') ? (
          ...
          <Box sx={{ my: theme.spacing(2) }}>
            ...
            >
              <ErrorOutlineIcon fontSize="small" sx={{ color: alpha(theme.palette.warning.main, 0.7) }} />
              <Typography variant="body2" sx={{ color: alpha(headerTextColor, 0.7) }}>
                Baybayin conversion unavailable
              </Typography>
            </Box>
          </Box>
        ) : isConvertingBaybayin ? (
