...
const WordExplorer: React.FC = () => {
  ...
  // Completely simplified handleRandomWord function for debugging
  const handleRandomWord = useCallback(async () => {
    // *** DEBUGGING: Track when this function is called ***
    console.log("%c📢 handleRandomWord FUNCTION CALLED", "background: #4CAF50; color: white; font-weight: bold; padding: 3px 5px; border-radius: 3px;");
    console.trace("handleRandomWord call stack");
    
    // TEMPORARILY DISABLE THE ACTUAL API CALL FOR DEBUGGING
    console.log("API call to random endpoint has been disabled for debugging");
    ...
    setTimeout(() => {
      ...
      console.log("Random word loading simulation completed");
    }, 500);
    
    // *** DO NOT MAKE ACTUAL API CALL DURING DEBUGGING ***
    
  }, []);  // Empty dependency array for debugging
  ...
  useEffect(() => {
    console.log("*** DEBUG: Component Mount Effect Running ***");
    
    // DISABLE automatic API testing on mount during debugging
    /*
    ...
    */
    ...
    // Manually set as connected for debugging
