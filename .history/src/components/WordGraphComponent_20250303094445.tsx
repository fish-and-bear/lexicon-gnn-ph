        ...
        <div style={{ marginLeft: '20px' }}>
          ...
          >
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M15 5L12 2M12 2L9 5M12 2V10M21 10V17C21 19.2091 19.2091 21 17 21H7C4.79086 21 3 19.2091 3 17V10" 
                stroke={theme === 'dark' ? '#fff' : '#444'} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
            Reset View
          </button>
        </div>
