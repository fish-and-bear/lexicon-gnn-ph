...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  // Implementation of double-click functionality for WordGraph.tsx

  // 1. Add these state variables to the WordGraph component
  const [isGraphTransitioning, setIsGraphTransitioning] = useState(false);
  const clickTimerRef = useRef<NodeJS.Timeout | null>(null);

  // 2. Define the transition duration constants
  ...
  // 4. Implement the double-click handler
  ...
  // 5. Implement the transition overlay component
