                  ...
                  return (
                    <Chip
                      ...
                      sx={{
                                  ...
                                  variant="outlined"
                                  sx={{
                                    borderColor: alpha(relColor, isDarkMode ? 0.9 : 0.5),
                                    color: isDarkMode ? relColor : relColor,
                                    fontSize: '0.75rem',
                                    height: 'auto',
                                    padding: theme.spacing(0.25, 0),
                                    bgcolor: alpha(relColor, isDarkMode ? 0.25 : 0.05),
                                    my: 0.5,
                                    '& .MuiChip-label': { 
                                      px: 1, 
                                      py: 0.25, 
                                      ...
                                      color: isDarkMode ? relColor : 'inherit'
                                    },
                                    '&:hover': {
                                      backgroundColor: alpha(relColor, isDarkMode ? 0.35 : 0.1),
                                      borderColor: isDarkMode ? relColor : relColor,
                                      boxShadow: isDarkMode ? `0 0 5px ${alpha(relColor, 0.5)}` : 'none'
                                    }
                                  }}
                                />
                  );
