...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  useEffect(() => {
    ...
    console.log('WordDetails: Baybayin conversion check:', {
    ...
    // Always reset state on word change to ensure we try converting again
    if (wordInfo.lemma) {
    ...
    if (!wordInfo.has_baybayin && wordInfo.lemma && !isConvertingBaybayin && convertedBaybayin === null) {
      console.log('WordDetails: Will attempt Baybayin conversion');
  ...
  }, [wordInfo.lemma, wordInfo.has_baybayin, wordInfo.language_code]); // Keep dependencies minimal
