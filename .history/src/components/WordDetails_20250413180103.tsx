...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  const renderRelationsTab = () => {
    ...
    const relationCategories = [
      ...
      {
        name: "Form",
        types: ["variant", "spelling", "abbreviation", "form_of"],
      ...
      {
        name: "Derivation",
        types: ["derived", "affix", "derivative"],
              ...
              >
                ...
                >
                  {relations.map((relation, index) => {
                    ...
                    // Use original relation type for specific coloring
                    const originalType = relation.originalType || 'other';
                    const relColor = relationColors[originalType] || category.color;
                      ...
                      <Chip
                        ...
                        label={
                          <>
                            ...
                            {/* Show small type indicator in diminished text */}
                            {originalType !== category.name.toLowerCase() && (
                              <Typography 
                                component="span" 
                                sx={{ 
                                  fontSize: '0.65rem', 
                              ...
                              >
                                ({formatRelationType(originalType)})
                              </Typography>
                            )}
                          </>
                        }
                        ...
                        sx={{
                          ...
                          '& .MuiChip-label': { 
                            px: 1.5, 
                            fontWeight: 500,
                            overflow: 'visible' // Allow long text to show type
                          },
                          '&:hover': {
