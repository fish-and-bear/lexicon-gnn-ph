      ...
      nodeSelection: d3.Selection<d3.BaseType, CustomNode, SVGGElement, unknown>
       ...
       nodeSelection
        ...
        .on("mouseover", (event, d) => {
            ...
            nodeElement.raise();
             d3.selectAll(".node:not(:hover)").style("opacity", d => d.id === selectedNodeId || selectedNodeId === null ? 0.7 : 0.3 );
             d3.selectAll(".link:not(.highlighted)").attr("stroke-opacity", 0.2);
        ...
        .on("mouseout", (event, d) => {
            ...
            nodeElement.select("circle")
             ...
             d3.selectAll(".link").attr("stroke-opacity", (l: CustomLink) => (l.relationship === 'associated') ? 0.3 : 0.6);
             if (selectedNodeId) {
