  ...
  const renderHeader = () => {
    ...
    return (
      ...
      <Box sx={{ 
        ...
        <Stack direction="row" spacing={1} alignItems="flex-start" flexWrap="nowrap" sx={{ mb: theme.spacing(1.5) }}>
          {/* Lemma Typography - Allow grow/shrink/wrap */}
          <Typography 
            variant="h3" 
            component="h1" 
            className="word-details-header-lemma" // Keep class for potential CSS targeting
            sx={{ 
              flexGrow: 1, // Allow to take available space
              minWidth: 0, // Allow to shrink below its content size
              fontWeight: 700, 
