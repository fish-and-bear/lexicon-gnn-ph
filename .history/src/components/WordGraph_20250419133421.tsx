...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  const setupNodeInteractions = useCallback((
      ...
      // Use direct event handling instead of d3's drag behavior
      nodeSelection.on("click", function(event, d) {
          ...
          console.log(`Click on node: ${d.word}`);
      ...
      // Add dedicated double-click handler that explicitly handles navigation
      nodeSelection.on("dblclick", function(event, d) {
          ...
          console.log(`Double-click on node: ${d.word} - Should navigate`);
          ...
          if (onNodeClick) {
              ...
              console.warn("onNodeClick function is not defined");
          }
      });
