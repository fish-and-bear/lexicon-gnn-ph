  ...
  useEffect(() => {
    ...
    if (!isMobile) {
      ...
      checkboxGroup.append("rect")
        ...
        .attr("height", 12)
        .attr("rx", 2)
        .attr("fill", showDisconnectedNodes ? (theme === "dark" ? theme.palette.primary.dark : theme.palette.primary.main) : (theme === "dark" ? "rgba(255,255,255,0.2)" : "rgba(0,0,0,0.1)"))
      ...
      if (showDisconnectedNodes) {
        checkboxGroup.append("path")
          ...
          .attr("fill", "none")
          .attr("stroke", theme === "dark" ? theme.palette.getContrastText(theme.palette.primary.dark) : theme.palette.primary.contrastText)
          .attr("stroke-width", 1.5)
