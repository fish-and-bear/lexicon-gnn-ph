...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  useEffect(() => {
    ...
    const categories = [
      ...
      { name: "Origin", types: ["root", "root_of", "isahod", "etymology", "cognate"] }, 
      { name: "Meaning", types: ["synonym", "antonym", "kasalungat", "related", "kaugnay", "kahulugan", "similar"] },
      { name: "Form", types: ["variant", "regional_variant", "atapat", "inatapat", "itapat"] },
      { name: "Structure", types: ["taxonomic", "part_whole", "component", "component_of"] },
      { name: "Derivation", types: ["derived", "derived_from", "sahod", "affix", "derivative"] },
...
const getRelationshipTypeLabel = (type: string): { group: string, label: string } => {
  switch (type.toLowerCase()) {
    ...
    // Origin group
    case 'root': return { group: 'Origin', label: 'Root Word' };
    case 'root_of': return { group: 'Origin', label: 'Root Of' };
    case 'isahod': return { group: 'Origin', label: 'Isahod' };
    ...
    case 'kasalungat': return { group: 'Meaning', label: 'Kasalungat' };
    case 'related': return { group: 'Meaning', label: 'Related' };
    case 'kaugnay': return { group: 'Meaning', label: 'Kaugnay' };
    case 'kahulugan': return { group: 'Meaning', label: 'Kahulugan' };
    case 'similar': return { group: 'Meaning', label: 'Similar' };
    
    // Form group
    case 'variant': return { group: 'Form', label: 'Variant' };
    case 'regional_variant': return { group: 'Form', label: 'Regional Variant' };
    case 'atapat': return { group: 'Form', label: 'Atapat' };
    case 'inatapat': return { group: 'Form', label: 'Inatapat' };
    case 'itapat': return { group: 'Form', label: 'Itapat' };
    
    // Structure group
    case 'taxonomic': return { group: 'Structure', label: 'Taxonomic' };
    case 'part_whole': return { group: 'Structure', label: 'Components/Parts' };
    case 'component': return { group: 'Structure', label: 'Component' };
    case 'component_of': return { group: 'Structure', label: 'Component Of' };
    
    // Derivation group
    case 'derived': return { group: 'Derivation', label: 'Derived' };
    case 'derived_from': return { group: 'Derivation', label: 'Derived From' };
    case 'sahod': return { group: 'Derivation', label: 'Sahod' };
    case 'affix': return { group: 'Derivation', label: 'Affix' };
    case 'derivative': return { group: 'Derivation', label: 'Derivative' };
