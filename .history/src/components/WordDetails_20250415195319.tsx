...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  useEffect(() => {
    ...
    if (!wordInfo.has_baybayin && wordInfo.lemma && !convertedBaybayin && !isConvertingBaybayin) {
    ...
    if (wordInfo.has_baybayin) {
      setConvertedBaybayin(null);
    }
  }, [wordInfo.lemma, wordInfo.has_baybayin, wordInfo.language_code, convertedBaybayin, isConvertingBaybayin]);
