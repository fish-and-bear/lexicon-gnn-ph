...
const WordExplorer: React.FC = () => {
  ...
  useEffect(() => {
    console.log("Checking API connection..."); // Keep log simpler
  ...
  // Depend only on fetch functions, not the cache itself to avoid re-running excessively
  }, [fetchRandomWordsForCache, fetchStatistics, getPartsOfSpeech]); // Adjusted dependencies
