  ...
  const renderHeader = () => {
    ...
    return (
      ...
      <Box sx={{ 
        ...
        pt: theme.spacing(3), 
        pb: theme.spacing(2), // Reduced bottom padding
        pl: theme.spacing(3), 
        pr: theme.spacing(2),
        ...
        {wordInfo.has_baybayin && wordInfo.baybayin_form && wordInfo.baybayin_form.trim() !== '' && (
          <Box sx={{ my: 0, mt: theme.spacing(1) }}> { /* Remove vertical margin, add small top margin */ }
        ...
        <Stack 
          ...
          spacing={3} 
          sx={{ 
            mt: 1, // Keep top margin low
            pt: 1, // Reduce top padding
