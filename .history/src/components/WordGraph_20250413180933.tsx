...
const getRelationshipTypeLabel = (type: string): { group: string, label: string } => {
  ...
  const normalizedType = (() => {
    ...
    if (['root_of', 'isahod'].includes(type.toLowerCase())) return 'root';
    ...
    if (['derived_from', 'sahod', 'affix', 'derivative'].includes(type.toLowerCase())) return 'derived';
