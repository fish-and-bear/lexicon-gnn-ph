                          ...
                          <Chip
                            ...
                            sx={{
                              ...
                              '&:hover': {
                                  ...
                                  ...(chipVariant === 'filled' && (() => { // Use IIFE to satisfy TS
                                      let colorToUse: string;
                                      if (chipColor === 'default') {
                                          colorToUse = theme.palette.grey[500]; // Use specific grey shade
                                      } else {
                                          // chipColor here is guaranteed to be 'primary', 'secondary', etc.
                                          colorToUse = theme.palette[chipColor].main;
                                      }
                                      return { 
                                          bgcolor: alpha(colorToUse, 0.85) 
                                      };
                                  })())
                              }
                            }}
