...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  const getNodeColor = useCallback((group: string): string => {
    ...
    switch (group.toLowerCase()) {
      // Core
      case "main": return "#2563eb"; // Reverted to original blue for main word
      
      // Origin group - Reds/oranges with more separation
      case "root": return "#e11d48"; // Crimson red
      case "etymology": return "#be185d"; // Deeper magenta
      case "cognate": return "#f97316"; // Vivid orange
      
      // Meaning group - Blues/teals with more separation
      case "synonym": return "#0ea5e9"; // Brighter sky blue
      case "related": return "#06b6d4"; // Cyan
      case "antonym": return "#1e3a8a"; // Navy blue
      
      // Form group - Purples
      case "variant": return "#9333ea"; // Improved purple contrast
      
      // Hierarchy group - More distinct greens
      case "taxonomic": return "#10b981"; // Teal-green
      case "part_whole": return "#22c55e"; // Bright green
      case "component_of": return "#22c55e"; // Same as part_whole
      
      // Info group - Yellows/ambers
      case "usage": return "#d97706"; // Darker amber for better contrast
