  ...
  const renderHeader = () => {
    ...
    return (
      ...
      <Box sx={{ 
        ...
        {/* Lemma and Audio Button - Use Grid for better control */}
        <Grid container spacing={1} alignItems="flex-start" wrap="nowrap" sx={{ mb: theme.spacing(1.5) }}>
          <Grid item xs> {/* This item will grow and shrink */} 
            <Typography 
              variant="h3" 
              component="h1" 
              sx={{ 
                ...
                minWidth: 0, // Still needed for shrinking
                '&::after': {
                  content: '""',
                  position: 'absolute',
                  bottom: -4,
          ...
          {hasAudio && (
            <Grid item> {/* This item takes its content size */} 
              <IconButton
                onClick={playAudio}
                size="medium"
                  ...
                  {defs.map((def: Definition, index: number) => {
                    ...
                    <ListItem 
                      ...
                      sx={{ 
                        ...
                        pl: 0, // Reset padding for list item
                        // Add padding bottom only if it's NOT the last definition needing a source below it
                        pb: isLastDefinitionForSource && sourceName !== 'Unknown Source' ? 0.5 : 1.5, 
                      }}
                    >
                      {/* Definition text */}
                      <ListItemText
                      ...
                      {/* Display Source only once after the LAST definition for this source */}
