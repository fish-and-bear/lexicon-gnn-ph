  ...
  return (
    <div className="graph-container" style={{ position: 'relative', width: '100%', height: '100%', overflow: 'hidden' }}>
      ...
      <div className="controls-container" style={{ pointerEvents: 'none' /* Ignore clicks on container */ }}>
        ...
        {/* REMOVED Conditional Network Controls - Render both, hide with CSS */}
        {/* {!isMobile ? ( */}
          {/* Desktop: Static controls - Always render */}
          <NetworkControls
            depth={depth}
            breadth={breadth}
          ...
          />
        {/* ) : ( */}
          {/* Mobile: Button to open Drawer - Always render */}
          <IconButton
            ...
            sx={{
                // Keep existing styles, but visibility handled by CSS
                position: 'absolute',
                bottom: theme => theme.spacing(2),
                right: theme => theme.spacing(2),
                width: 40, height: 40, minWidth: 40, minHeight: 40, padding: 0,
      ...
      {/* Mobile Controls Drawer - Keep conditional on isMobile */}
      {isMobile && (
        <Drawer
          anchor="bottom"
          open={controlsOpen}
