  ...
  return (
    <div className={`word-explorer ${theme}`}>
      ...
      <main>
        ...
        {!isLoading && !error && (
          <div>
            {/* Temporarily comment out WordDetails rendering for debugging */}
            {/* {selectedWordInfo ? ( 
              <WordDetails 
                ...
                onEtymologyNodeClick={handleWordLinkClick} 
              />
            ) : searchResults.length > 0 ? ( ... ) : ( ... ) } */}
            
            {/* Always show search results for debugging */} 
            {searchResults.length > 0 ? (
              <div>
            ...
            {/* Display selected word info temporarily for debug */} 
