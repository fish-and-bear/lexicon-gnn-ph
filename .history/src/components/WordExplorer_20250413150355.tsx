...
const WordExplorer: React.FC = () => {
  ...
  useEffect(() => {
    ...
    if (wordData && wordData.id) {
      ...
      // If there are no relations in the current wordData but we have network data, 
      // try to fetch the full word details again to get the relations
      if (!hasRelations && wordNetwork && mainWord) {
        console.log("Word has no relations but network exists. Fetching complete word details.");
        fetchWordDetails(wordData.id.toString())
          .then(fullWordData => {
            ...
            if (
              ...
              console.log("Got relations from direct word details:", {
