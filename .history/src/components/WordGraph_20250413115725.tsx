  ...
  useEffect(() => {
    ...
    svg.selectAll(".node")
      .each(function(d: any) {
        ...
        const isVisible = filteredRelationships.includes(nodeRelationship);
    ...
    svg.selectAll(".link")
      .each(function(d: any) {
        ...
        console.log("Link relationship:", linkRelationship, "Is in filters:", filteredRelationships.includes(linkRelationship));
        const isVisible = filteredRelationships.includes(linkRelationship);
