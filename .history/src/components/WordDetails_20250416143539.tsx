                  ...
                  <Box mt={0.5}>
                    <Typography variant="caption" color="text.secondary">
                      Source: {typeof pronunciation.sources === 'string' 
                              ? pronunciation.sources 
                              : (Array.isArray(pronunciation.sources) && pronunciation.sources.length > 0)
                                ? pronunciation.sources.join(', ') 
                  ...
                  <ListItemText
                    ...
                    secondary={
                      <Box>
                        ...
                        {affix.sources && affix.sources.length > 0 && (
                          <Typography variant="caption" display="block" sx={{ mt: 0.5 }}>
                            Source: {Array.isArray(affix.sources) ? 
                                   affix.sources.join(', ') : 
                                   affix.sources}
                          </Typography>
                        )}
