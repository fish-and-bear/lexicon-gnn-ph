          ...
          <div key={posName} className="pos-group">
            ...
            <div className="definition-cards-container">
              {definitions.map((definition: Definition, index: number) => {
                ...
                // Instead of directly using the function in JSX, pre-process the text
                // and determine what to render based on the result
                let processedText;
                const match = definitionText ? definitionText.match(/^(.*[^\d])(\d+)$/) : null;
