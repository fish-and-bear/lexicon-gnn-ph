...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  useEffect(() => {
    ...
    const checkboxContainer = legendContainer.append("g")
    ...
    // Add checkbox square
    const checkbox = checkboxContainer.append("rect")
      .attr("width", 14)
      .attr("height", 14)
      .attr("rx", 2)
      .attr("x", 0)
    ...
    const checkmark = checkboxContainer.append("path")
      .attr("d", "M3,-1 L6,2 L11,-4")
      .attr("stroke", theme === "dark" ? "#fff" : "#333")
      .attr("stroke-width", 2)
      .attr("fill", "none")
      .attr("stroke-linecap", "round")
      .attr("stroke-linejoin", "round")
      .style("opacity", showDisconnectedNodes ? 1 : 0);
