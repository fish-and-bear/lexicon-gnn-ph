...
import unidecode from "unidecode"; // Restored import
import { 
  fetchWordNetwork, 
  fetchWordDetails, 
  searchWords, 
...
import axios from 'axios'; // Restored import
// import DOMPurify from 'dompurify'; // Keep commented out for now
import { debounce } from "lodash"; // Restored import
...
const WordExplorer: React.FC = () => {
  ...
  }, [mainWord, fetchWordNetworkData, normalizeInput]); // Restored normalizeInput dependency
