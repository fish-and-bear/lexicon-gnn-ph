    ...
    return (
      <AppBar position="static" color="default" elevation={1}>
        <Toolbar variant="dense">
          ...
          {/* Search Autocomplete */}
          <Box sx={{ flexGrow: 1, flexShrink: 1, minWidth: '100px', px: theme => theme.spacing(1) }}> {/* Allow shrinking, set minWidth */}
            <Autocomplete<
              WordSuggestion | string,
              false, // Multiple
              false, // DisableClearable
          ...
          {/* Action Buttons */}
          <Box sx={{ display: 'flex', gap: 0.5, flexShrink: 0 }}> {/* Prevent button group from shrinking */}
            <Button
              variant="contained"
