...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  // Add handler for toggling relationship filters (reinstated)
  ...
  // Define getNodeRadius before transitionToNewMainWord
  ...
  }, [filteredNodes, getNodeRadius, getNodeColor, onNodeClick, zoomRef, svgRef]); // getNodeRadius dependency is correct now
      ...
      >
        <defs>
          <marker
            ...
            markerWidth={6}
            markerHeight={6}
            overflow="visible" // Ensure this is overflow, not xoverflow
          >
            <path
