...
const ValueDisplay = styled(Box)(({ theme }) => ({
  ...
  borderRadius: '4px',
  padding: '0 4px',
  backgroundColor: alpha('var(--primary-color, #1976d2)', 0.1),
  border: '1px solid',
  borderColor: alpha('var(--primary-color, #1976d2)', 0.2),
...
const StyledSlider = styled(Slider)(({ theme }) => ({
  ...
  '& .MuiSlider-thumb': {
    ...
    '&:hover, &.Mui-focusVisible': {
      boxShadow: '0 0 0 8px ' + alpha('var(--primary-color, #1976d2)', 0.16),
      transform: 'scale(1.15)'
    },
    '&.Mui-active': {
      boxShadow: '0 0 0 12px ' + alpha('var(--primary-color, #1976d2)', 0.24),
  ...
  '& .MuiSlider-track': {
    height: 4,
    borderRadius: 2,
    background: 'linear-gradient(90deg, var(--primary-color-light, rgba(29, 53, 87, 0.6)) 0%, var(--primary-color, #1976d2) 100%)'
  },
  '& .MuiSlider-rail': {
    height: 4,
    borderRadius: 2,
