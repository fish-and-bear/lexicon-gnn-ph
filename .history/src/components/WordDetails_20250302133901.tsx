  ...
  const renderEtymology = (word: WordInfo) => {
    ...
    return (
      <div className="etymology-section">
        {/* Only render the organized components once */}
        {allComponents.length > 0 && renderOrganizedComponents(allComponents)}
        
        {/* Remove the component cloud since it's redundant with the organized components */}
        
        {/* Only render etymology categories if they have content */}
        {(categorizedEtymologies.inheritance.length > 0 || 
          categorizedEtymologies.influence.length > 0 || 
          categorizedEtymologies.comparison.length > 0 || 
          categorizedEtymologies.other.length > 0) && (
