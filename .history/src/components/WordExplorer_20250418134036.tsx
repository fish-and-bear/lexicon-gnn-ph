...
// import WordGraph from "./WordGraph"; // Step 1: Comment out WordGraph import
...
const WordExplorer: React.FC = () => {
  ...
  console.log('>>> Full WordExplorer rendering (WordGraph commented out) <<<'); // Add log
                ...
                <div className="graph-container" style={{ width: '100%', height: '100%' }}>
                  <div className="graph-content" style={{ width: '100%', height: '100%' }}>
                    ...
                    {!isLoading && !wordNetwork && !error && (
                      <div className="empty-graph">Enter a word to explore its network. (Graph commented out)</div>
                    )}
                  </div>
                </div>
              </Panel>
