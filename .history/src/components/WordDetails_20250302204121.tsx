...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({ wordInfo, onWordClick }) => {
  ...
  const renderRelatedWords = () => {
    ...
    // Extract related words from the relations structure with new types
    ...
    const hasRelations = synonyms.length > 0 || antonyms.length > 0 || 
                         derivatives.length > 0 || derivativeWords.length > 0 || 
                         variants.length > 0 || related.length > 0 || 
                         associatedWords.length > 0 || etymologyWords.length > 0 ||
                         mainWords.length > 0 || otherWords.length > 0 || rootWord;
