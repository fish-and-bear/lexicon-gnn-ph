    ...
    return (
      <div className="search-container">
        ...
        <div className="search-input-container">
          <input
            ...
            onChange={(e) => {
              ...
              // DEBUGGING: Temporarily disable debounced search to eliminate as potential source of unwanted API calls
              // handleDebouncedSearch(newValue);
              console.log("Search input changed, but debounced search disabled for debugging");
            }}
            onKeyDown={(e) => {
              if (e.key === 'Enter') {
                e.preventDefault();
        ...
        <Button
          ...
          title="Get a random word (EXPLICITLY TRIGGERED)"
          sx={(theme) => ({
            mx: 0.1, 
            whiteSpace: 'nowrap',
    ...
    <div className={`word-explorer ${theme} ${isLoading ? 'loading' : ''}`}>
      <header className="header-content">
        ...
        <div className="header-buttons">
          {/* DEBUGGING: Only enable Random Word button for explicit testing */}
          <button
            onClick={handleRandomWord}
            className="random-button"
            title="Get a random word (EXPLICITLY TRIGGERED)"
          ...
          {/* DEBUGGING: Temporarily disable these buttons to eliminate potential sources of random calls */}
          {/* 
          <button
