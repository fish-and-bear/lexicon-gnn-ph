...
// import WordDetails from "./WordDetails"; // Step 2: Comment out WordDetails import
...
const WordExplorer: React.FC = () => {
  ...
  console.log('>>> Full WordExplorer rendering (WordDetails commented out) <<<'); // Updated log
              ...
              <Panel defaultSize={40} minSize={25} style={{ overflow: 'hidden', height: '100%', width: '100%' }}>
                ...
                <div ref={detailsContainerRef} className="details-container" style={{ width: '100%', height: '100%', overflow: 'auto' }}>
                  ...
                  {/* {!isLoading && selectedWordInfo && (
                    <WordDetails // Step 2: Comment out WordDetails usage
                  ...
                  {!isLoading && !selectedWordInfo && (
                    <div className="no-word-selected">Select a word or search to see details. (Details commented out)</div>
                  )}
