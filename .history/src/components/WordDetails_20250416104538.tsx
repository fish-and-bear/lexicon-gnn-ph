    ...
    return (
      ...
      <Box sx={{ 
        ...
        <Stack direction="row" spacing={1} alignItems="flex-start" sx={{ mb: theme.spacing(1.5) }}>
          {/* Wrap Typography in a Box that can grow and shrink */}
          <Box sx={{ flexGrow: 1, minWidth: 0 }}> 
            <Typography 
              ...
              sx={{
                ...
                overflowWrap: 'break-word', // Stronger wrapping guarantee
                width: '100%', 
                '&::after': {
                  content: '""',
                  position: 'absolute',
          ...
          {/* Keep flexShrink: 0 on the button */}
          {hasAudio && (
            <IconButton
              onClick={playAudio}
              size="medium"
              ...
              sx={{
                ...
                mt: 0.5, 
                bgcolor: 'transparent',
                flexShrink: 0, // Crucial: prevent icon button from shrinking
                '&:hover': { 
