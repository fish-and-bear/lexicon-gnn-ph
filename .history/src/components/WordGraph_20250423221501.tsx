...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  }, [mainWord, onNodeClick, getNodeColor, themeMode, nodeMap, baseLinks, getNodeRadius, tooltipTimeoutId]); // Updated dependency array to include themeMode and tooltipTimeoutId
