...
const WordGraph: React.FC<WordGraphProps> = ({
  ...
  const setupNodeInteractions = useCallback((
    nodeGroups: d3.Selection<Element, CustomNode, SVGGElement, unknown>,
  ...
  useEffect(() => {
    ...
    // Use type assertions for both parameters to ensure type compatibility
    setupNodeInteractions(
      nodeElements as d3.Selection<Element, CustomNode, SVGGElement, unknown>,
      linkGroups as d3.Selection<SVGPathElement, CustomLink, SVGGElement, unknown>
    );
