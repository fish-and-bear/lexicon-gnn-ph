...
const WordDetails: React.FC<WordDetailsProps> = React.memo(({
  ...
  const renderRelationsTab = () => {
    ...
    // Check if wordNetwork is available in wordInfo
    const wordNetwork = wordInfo.wordNetwork || window.wordNetwork;
    
    // Get semantic network data from wordNetwork or from semantic_network
    ...
    function createRelationsFromNetwork() {
      ...
      semanticNetworkLinks.forEach(link => {
        ...
        const sourceNode = semanticNetworkNodes.find(n => n.id === sourceId);
        const targetNode = semanticNetworkNodes.find(n => n.id === targetId);
    ...
    // Always check if wordNetwork contains data even if we couldn't parse relations
    const hasVisibleNetwork = Boolean(wordNetwork && 
