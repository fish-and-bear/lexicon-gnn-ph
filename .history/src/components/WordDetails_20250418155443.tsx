  ...
  */
  ...
  return (
    ...
    >
      ...
      {/* --- DEBUG: Comment out original Content Section using JSX comments --- */}
      {/* 
      <Box sx={{ flexGrow: 1, display: 'flex', flexDirection: isWideScreen ? 'row' : 'column', overflow: 'hidden' }}>
        <Tabs
          ...
          variant="scrollable"
          // value={activeTab} // State commented out
          // onChange={handleTabChange} // Handler commented out
          aria-label="Word details tabs"
          sx={{
            borderRight: `1px solid ${theme.palette.divider}`,
            borderBottom: !isWideScreen ? `1px solid ${theme.palette.divider}` : 'none',
            borderColor: 'divider',
            minWidth: isWideScreen ? 150 : 'auto',
            flexShrink: 0,
        ...
        >
          {/* availableTabs is commented out */}
          <Tab key="loading-placeholder" label="Tabs Disabled" value="loading-placeholder" disabled />
        </Tabs>
