...
const WordExplorer: React.FC = () => {
  console.log('WordExplorer component mounting (unidecode commented)');
  ...
  console.log('WordExplorer: Reached end of setup (unidecode commented), before return statement.');
