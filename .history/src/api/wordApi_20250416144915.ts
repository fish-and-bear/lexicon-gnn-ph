...
function normalizeWordData(rawData: any): WordInfo {
  ...
  if (wordData.forms && Array.isArray(wordData.forms)) {
      ...
      normalizedWord.forms = wordData.forms.map((form: any) => ({
          id: form.id,
          word_id: form.word_id,
          form_type: form.form_type || 'unknown',
          form_value: form.form_value || '',
          tags: form.tags || null,
          form_metadata: form.form_metadata || null,
  ...
  // Normalize Templates (Assuming structure based on WordInfo type)
   if (wordData.templates && Array.isArray(wordData.templates)) {
       ...
       normalizedWord.templates = wordData.templates.map((template: any) => ({
           id: template.id,
           word_id: template.word_id,
           template_name: template.template_name || 'unknown',
           template_structure: template.template_structure || null,
           tags: template.tags || null,
           template_metadata: template.template_metadata || null,
