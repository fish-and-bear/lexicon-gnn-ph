...
// Helper function to split strings by semicolon, trimming whitespace - Signature Updated
function splitSemicolonSeparated(value: string | string[] | undefined): string[] {
...
// Helper function to split strings by comma, trimming whitespace - Signature Updated
function splitCommaSeparated(value: string | string[] | undefined): string[] {
  if (Array.isArray(value)) {
    return value.filter((item): item is string => typeof item === 'string');
  }
  if (typeof value === 'string') {
