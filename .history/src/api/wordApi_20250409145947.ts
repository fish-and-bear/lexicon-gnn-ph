    ...
    try {
      ...
      const result: WordNetwork = {
        nodes: networkData.nodes.map((n: any) => ({ 
          id: n.id, 
          label: n.label || n.lemma || n.id.toString(), // Fallback label
          word: n.label || n.lemma || n.id.toString(), // Use label/lemma for word too
          language: n.language,
          type: n.type || 'unknown', // Use type if available
          depth: n.depth, // Use depth if available
          definitions: n.definitions, // Use definitions if available
          path: n.path, // Use path if available
          has_baybayin: n.has_baybayin,
          baybayin_form: n.baybayin_form
        })),
        ...
        metadata: networkData.metadata || {
          ...
          total_edges: networkData.edges.length,
          include_affixes,
          include_etymology,
          cluster_threshold
        },
