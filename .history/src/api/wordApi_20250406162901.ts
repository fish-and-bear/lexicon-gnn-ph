    ...
    if (responseData.results && responseData.results.length > 0) {
      ...
      if (apiOptions.include_full) {
        try {
          ...
          console.log(`Normalized ${result.words.length} full word results`);
          ...
          console.log(`Created ${result.words.length} basic word results after normalization error`);
        }
      } 
      // For include_full=false, the results contain basic word info
        ...
        console.log(`Created ${result.words.length} basic word results`);
      }
    }
