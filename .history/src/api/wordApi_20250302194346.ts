...
function normalizeWordData(data: any): WordInfo {
  ...
  const normalizedWord: WordInfo = {
    ...
    is_root_word: wordData.is_root_word || false
  };
  ...
  if (wordData.relations) {
    ...
    const relationTypes = ['synonyms', 'antonyms', 'variants', 'related'];
  ...
  if (wordData.relations && wordData.relations.affixations) {
    normalizedWord.relations['affixations'] = wordData.relations.affixations;
  }
