...
function normalizeWordData(rawData: any): WordInfo {
  ...
  // Log the raw relation data before normalization
  console.log("Raw relation data received by normalizeWordData:", {
    incoming: wordData.incoming_relations,
    outgoing: wordData.outgoing_relations,
    definition_relations_top_level: wordData.definition_relations,
    definitions_with_relations: wordData.definitions?.filter((def: any) => def.definition_relations?.length > 0)
  });
