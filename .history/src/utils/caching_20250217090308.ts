import { WordNetwork, WordInfo, Statistics, PartOfSpeech, EtymologyTree } from "../types";
...
type CacheableData = WordNetwork | WordInfo | Statistics | PartOfSpeech[] | EtymologyTree;
