...
export interface Relations {
  ...
  related?: RelatedWord[];
  derived?: RelatedWord[];  // derived_from relationships
  root?: RelatedWord | null;  // root_of relationships
  
  // Additional relation types from backend
  component_of?: RelatedWord[];  // component_of relationships
  cognate?: RelatedWord[];  // cognate relationships
  
  // Semantically organized categories
  main?: RelatedWord[];  // Main word relationships
  derivative?: RelatedWord[];  // Derivative relationships
  etymology?: RelatedWord[];  // Etymology relationships
  associated?: RelatedWord[];  // Associated word relationships  
