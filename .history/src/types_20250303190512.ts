...
export interface NetworkClusters {
  etymology: NetworkNode[];
  affixes: NetworkNode[];
  synonyms: NetworkNode[];
  antonyms: NetworkNode[];
  variants: NetworkNode[];
  root_words: NetworkNode[];
  derived_words: NetworkNode[];
...
export interface WordNetworkGraph {
  word: string;
  nodes: NetworkNode[];
  edges: NetworkEdge[];
...
export interface WordNetworkLists {
  main_words: string[];
  root_words: string[];
  antonyms: string[];
...
export type WordNetwork = WordNetworkGraph | WordNetworkLists;
...
export interface WordNetworkOptions {
  ...
  max_nodes?: number;  // Maximum number of nodes to return in the network
  limit_nodes?: boolean; // Whether to limit the number of nodes
  limit_edges?: boolean; // Whether to limit the number of edges
