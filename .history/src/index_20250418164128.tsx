...
import './index.css'; // This imports all CSS including variables
import App from './App';
import reportWebVitals from './reportWebVitals';
import { ThemeProvider } from './contexts/ThemeContext';
import { resetCircuitBreaker } from './api/wordApi';

// --- Add process polyfill for libraries like axios --- 
if (typeof window !== 'undefined' && typeof window.process === 'undefined') {
  (window as any).process = {
    env: { NODE_ENV: process.env.NODE_ENV || 'development' }, // Use actual NODE_ENV if available
    version: '', // Provide minimal necessary properties
    cwd: () => '',
    // Add other properties if specific libraries complain
  };
}
// --- End polyfill ---
