...
// import App from './App'; // Keep App imported but don't render it yet

console.log('src/index.tsx: All core component imports loaded.');

// Everything else is removed or commented out for this test
/*
// import App from './App'; // Already uncommented above
// import { ThemeProvider } from './contexts/ThemeContext'; // Already uncommented above
...
console.log('index.tsx: Attempting ReactDOM.render with ThemeProvider + simple div...');

try {
  ReactDOM.render(
    <React.StrictMode>
      <ThemeProvider>
        {/* <App /> */} {/* Render simple div instead of App */}
        <div>Test Content Inside ThemeProvider</div> 
      </ThemeProvider>
    </React.StrictMode>,
    document.getElementById('root')
  );
  console.log('index.tsx: ReactDOM.render with ThemeProvider + div called successfully.');
} catch (error) {
  console.error('index.tsx: Error during ReactDOM.render with ThemeProvider + div:', error);
}
