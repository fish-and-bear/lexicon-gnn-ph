...
export interface WordInfo {
  ...
  // --- Spelling & Root Info ---
  preferred_spelling?: string | null;
  root_word_id?: number | null; // Raw ID
  root_word?: BasicWord | null; // Transformed object

  // --- Pronunciation (Transformed) ---
  pronunciation: CleanPronunciation | null;
  ...
  relations: Relations; // Structured object by type
  all_relations?: CleanRelation[]; // Flat list of all relations
  relation_summary?: Record<string, number>; // Counts by type
  
  // --- Affixations (Transformed) ---
  affixations?: CleanAffixation[]; // Flat list of all affixations
  derived_words?: BasicWord[]; // Words derived *from* this one
  
  // --- Other Associated Data ---
  credits?: Credit[];
  idioms: Idiom[];
  source_info?: Record<string, any>; // Raw source info
  search_text?: string; // Raw search text
  ...
  // Add any other fields from RawWordComprehensiveData if needed
